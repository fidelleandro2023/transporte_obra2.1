...
//	  if(GlobalSelectSubProyecto !== undefined){
//		  $('#selectSubAdju').html(GlobalSelectSubProyecto);
//	  }
//	  if(GlobalSelectEECC !== undefined){
//		  $('#selectEECCDiseno').html(GlobalSelectEECC);
//	  }
//	  if(GlobalSelectMDF !== undefined){
//		  $('#selectCentral').html(GlobalSelectMDF);
//	  }
