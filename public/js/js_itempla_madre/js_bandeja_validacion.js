...
function validarOpex(itemPlan, colum) {
    ...
    if (selectEstado === '' || selectEstado === 0) {
        ...
        $.ajax({
            url: 'itValidar',
            type: "POST",
            data: {itemPlan: itemPlan, textComentario: textComentario, selectEstado: selectEstado, colum: colum, itemPlanPE: itemPlanPE},
            dataType: "JSON",
