...
define('ANIO_CREATE_ITEMPLAN' , '23');
define('ANIO_CREATE_PO'       , '2023');
define('ID_FASE_ANIO_CREATE_ITEMPLAN' , '9');
...
defined('RUTA_PLUGINS') OR define('RUTA_PLUGINS', 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/public/plugins/');
defined('RUTA_FONTS')   OR define('RUTA_FONTS'  , 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/public/fonts/');
defined('RUTA_CSS')     OR define('RUTA_CSS'    , 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/public/css/');
defined('RUTA_JS')      OR define('RUTA_JS'     , 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/public/js/');
defined('RUTA_IMG')     OR define('RUTA_IMG'    , 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/public/img/');
...
defined('RUTA_NOTICIAS') OR define('RUTA_NOTICIAS', 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/uploads/noticias/');

defined('RUTA_VIDEO') OR define('RUTA_VIDEO', 'http://'.(isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : null).'/obra2.1/uploads/video_panel/');
...
define('FLG_SUB_NO_CODIGO', '1');
define('FLG_SUB_CODIGO'   , '2');
...
define('ESTADO_07_TEXTO', '007 - PROPUESTA - DESESTIMADA');