<?php
class M_edit_crecimiento_vertical_negocio extends CI_Model{
	...
	function updateItemplanCVNegocio($idProy, $idSubproy, $eelec, $fechaInicio, $nombreProyecto, $indicador, $uip, $cordx, $cordy, $cantidadTroba, $departamento,
		...
		$email_1, $contacto_2, $telefono_2_1, $telefono_2_2, $email_2, $accion, $itemplan, $estado_edifi, $idCentral, $competencia, $prioridad, $idEECC, $uploadfile, $tipoSubProy, $operador, 
	...
	function updateEvidCv($dataUbic) {
         $this->db->insert('planobra_detalle_cv_log', $dataUbic);
        if($this->db->affected_rows() != 1) {
            return array('error' => EXIT_ERROR,
                         'msj'   => 'error al subir archivo');
        } else {
