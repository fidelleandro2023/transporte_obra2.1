<?php
class M_bandeja_certificacion_transporte extends CI_Model{
    ...
    function getDataCertificacion($idEstadoPlan, $fechaIn, $fechaFin, $idEecc) {
				...
				WHERE paz.itemplan = po.itemplan
				  ...
				  AND CASE WHEN ? IS NOT NULL AND ? IS NULL     THEN po.fechaEjecucion BETWEEN '".$fechaIn."' AND NOW()
					...
					GROUP BY po.itemplan,
							po.idSubProyecto";
        $result = $this->db->query($sql, array($idEecc, $fechaIn, $fechaFin, $fechaIn, $fechaFin, $fechaIn, $fechaFin));
