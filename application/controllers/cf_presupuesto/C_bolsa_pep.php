...
class C_bolsa_pep extends CI_Controller {
    ...
    public function index(){
	    ...
	    if($logedUser != null){
               ...
               $data['tablaSiom']     = $this->getTablaSiom($this->m_bolsa_pep->getPepBolsaList("", "", "","", $idUsuario));               
               ...
               $result = $this->lib_utils->getHTMLPermisos($permisos, 319, 320, ID_MODULO_ADMINISTRATIVO);
    ...
    function savePep1Pep2BolsaPep() {
        ...
        try {
            ...
            $data = $this->m_bolsa_pep->insertPepSubProyectoBolsa($arrayInsert,$pep1,$idFase);

            //correativo desde bosa
