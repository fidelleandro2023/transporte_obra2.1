 ...
 *
 */
class C_editar_planobra_fase extends CI_Controller {
	...
	public function index(){
	    ...
	    if($logedUser != null){
        	   ...
        	   $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PERMISO_PADRE_PLAN_DE_OBRA, 267);
        	   $data['opciones'] = $result['html'];
        	   if($result['hasPermiso'] == true){
        	         $this->load->view('vf_plan_obra/v_editar_planobra_lite_2',$data);
        	   }else{
