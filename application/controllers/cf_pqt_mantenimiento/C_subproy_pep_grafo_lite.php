 ...
 *
 */
class C_subproy_pep_grafo_lite extends CI_Controller {
	...
	public function index(){
	    ...
	    if($logedUser != null){    	          
	          ...
	          // $data['listaSubProy'] = $this->m_utils->getAllSubProyecto();
        	   ...
        	   $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PERMISO_PADRE_MANTENIMIENTO, ID_PERMISO_HIJO_SUBPROY_PEP_GRAFO_LITE);
        	   
        	   $data['opciones'] = $result['html'];
        	   if($result['hasPermiso'] == true){
        	         $this->load->view('vf_mantenimiento/v_subproy_pep_grafo_lite',$data);
        	   }else{
    ...
    public function makeHTLMTablaPepSubPro($lista){
        ...
        $html = '<table id="data-table" class="table table-bordered">
                ...
                $html .=' <tr>
                            <th><a data-id_ps ="'.$row->id_pep1_subpro.'" onclick="deletesubPep(this)"><img alt="Eliminar" height="20px" width="20px" src="public/img/iconos/delete.png"></a></th>
    ...
    public function makeHTLMTablaPep1Pep2($lista){
        ...
        foreach($lista->result() as $row){
            ...
            $html .=' <tr>
                            <th><a data-id_pp ="'.$row->id_relacion.'" onclick="deletePep1Pep2(this)"><img alt="Eliminar" height="20px" width="20px" src="public/img/iconos/delete.png"></a></th>
							<td>'.$row->pep1.'</td>
							<td>'.$row->pep2.'</td>
						</tr>';
        }
    ...
    public function addSubProPep(){
        ...
        try{
            ...
            $data = $this->m_subproy_pep_grafo->insertPepSubProyecto($subProyecto, $estacion, $area, $pep);
    ...
    public function insertSisePep2GrafoFromSisego(){
        ...
        try{
            ...
            if($data['error'] == EXIT_SUCCESS){
                $data = $this->m_utils->saveLogSigoplus('SISEGO PEP2 GRAFO', '', $itemplan, '', $indicador, $pep2, $grafo, 'TRAMA COMPLETADA', 'OPERACION REALIZADA CON EXITO', '1');                
            }
        }catch(Exception $e){
            $data = $this->m_utils->saveLogSigoplus('SISEGO PEP2 GRAFO', '', $itemplan, '', $indicador, $pep2, $grafo, 'TRAMA IMCOMPLETA', 'LOS PARAMETROS LLEGARON VACIOS', '2');            
            $data['msj'] = $e->getMessage();
        }
