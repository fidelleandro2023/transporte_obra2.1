...
class C_bandeja_preciarios extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($logedUser != null) {
            ...
            $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PERMISO_PADRE_MANTENIMIENTO_CERTIFICACION, 287, ID_MODULO_MANTENIMIENTO);
            $data['opciones'] = $result['html'];
            if ($result['hasPermiso'] == true) {
                $this->load->view('vf_mantenimiento/v_bandeja_preciarios', $data);
            } else {
            ...
            if ($flgExistePreciario == 0) {
                ...
                if (count($arrayInsertLogGlob) > 0) {
                    ...
                    if ($data['error'] == EXIT_SUCCESS) {
                        ...
                        $data['tablaPreciario'] = $this->makeHTLMTablaConsulta($this->m_utils->getAllPreciario($idEECC, $idZonal, $idEstacion, $idTipoPrecio));
                    }
                }
                ...
                $html .= '
                        <tr>
                            ...
                            <th style="text-align: center">
                                <a style="color:var(--verde_telefonica)" data-ideecc="' . $row->idEmpresaColab . '" data-idzonal="' . $row->idZonal . '" data-idprecdiseno="' . $row->idPrecioDiseno . '" data-idestacion="' . $row->idEstacion . '" onclick="openEditPreciario(this)"><i class="zmdi zmdi-hc-2x zmdi-edit"></i></a>
                                <!-- a style="color:var(--verde_telefonica)"   onclick="openModalConfiDelete(this)"><i class="zmdi zmdi-hc-2x zmdi-delete"></i></a -->
                            </th>
                        </tr>
                        ';
                $count++;
    ...
    public function filtrarTabla()
    {
        ...
        try {
            ...
            $data['tablaPreciario'] = $this->makeHTLMTablaConsulta($this->m_utils->getAllPreciario($idEECC, $idZonal, $idEstacion, $idPrecioDiseno));
    ...
    public function getDetPreciario()
    {
        ...
        try {
            ...
            $arrayPreciario = $this->m_utils->getAllPreciario($idEECC, $idZonal, $idEstacion, $idTipoPrecio, 1);
