...
class C_registro_oc_solicitud_masivo_cert extends CI_Controller {
    ...
    public function index() {
        ...
        if ($logedUser != null) {
            ...
            if ($result['hasPermiso'] == true) {
                $this->load->view('vf_certificacion/v_registro_oc_solicitud_masivo_cert', $data);
            } else {
    ...
    public function makeHTMLBodyTable($row_dimension, $objPHPExcel) {
        ...
        for ($i = 1; $i <= $row_dimension['row']; $i++) {//COMIENZA DESDE LA FILA 1
            ...
            if ($B != '' && $A != 'CODIGO SOLICITUD') {
                $infoSol = $this->m_registro_oc_solicitud_masivo_cert->getInfoSolicitudOCCreaByCodigo(trim($A));
                if($infoSol != null){
        ...
        try {
            ...
            if ($idUsuario != null) {               
                    ...
                    if ($arrayFile != null) {
                        ...
                        $data = $this->m_registro_oc_solicitud_masivo_cert->masiveUpdateAtencionCreateSolOC($itemplanList, $solicitudesList);				
                    } else {
