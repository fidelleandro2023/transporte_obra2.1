...
class C_creacion_solicitud_anulacion_masivo extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->output->set_header('Content-Type: text/html; charset=ISO-8859-1');
        $this->load->model('mf_certificacion/m_creacion_solicitud_anulacion_masivo');
    ...
    public function index() {
        ...
        if ($logedUser != null) {
            ...
            if ($result['hasPermiso'] == true) {
                $this->load->view('vf_certificacion/v_creacion_solicitud_anulacion_masivo', $data);
            } else {
    ...
    public function getExcelPartidasMO() {
        ...
        try {
                    ...
                    $contador = 1;
                    $titulosColumnas = array('ITEMPLAN');
    ...
    public function makeHTMLBodyTable($row_dimension, $objPHPExcel) {
        ...
        for ($i = 1; $i <= $row_dimension['row']; $i++) {//COMIENZA DESDE LA FILA 1
            ...
            $total = 0;
            if ($A != 'ITEMPLAN') {
                $infoSol = $this->m_creacion_solicitud_anulacion_masivo->getInfoSolicitudOCCreaByCodigo(trim($A));
                if($infoSol != null){
                            ...
                            if($infoSol['has_sol_edicion_pdt']    >   0){
                                ...
                                if($infoSol['has_sol_certificacion']    >   0){
                                    ...
                                    if($infoSol['has_sol_anulacion']    >   0){                               
                                        ...
                                        $pre_array = array($infoSol['itemplan']);
        ...
        try {
            ...
            if ($idUsuario != null) {               
                    ...
                    if ($arrayFile != null) {
                            ...
                            if ($datos != null) {                                
                                ...
                                if($infoCreateSol    !=  null){
                                    ...
                                    if($codigo_solicitud    !=  null){
                                        ...
                                        $solicitud_oc_anulapos = array('codigo_solicitud'  => $codigo_solicitud,
                                            ...
                                            'tipo_solicitud'    =>  4//tipo anulacion
                                        
                                        );
                                        array_push($arraySolicitud, $solicitud_oc_anulapos);
                        ...
                        */
                       $data = $this->m_creacion_solicitud_anulacion_masivo->generarSolicitudesDeAnulacion($arraySolicitud, $arrayItemXSolicitud, $arrayItemplan);                       
                    } else {
