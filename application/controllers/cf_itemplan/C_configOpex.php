...
class C_configOpex extends CI_Controller {
    ...
    public function datoUnico() {
        $idSubproyecto = $this->input->post('idsubproyecto');
        $datounico = $this->configOpex->getDatoUnico($idSubproyecto);
       
        echo json_encode($datounico);
    }

    public function ajaxCantidadxFase() {
        $idSubproyecto = $this->input->post('idsubproyecto');
        $fase = $this->input->post('fase');
        $info_fase = $this->configOpex->getFase($fase);
        $datounico = $this->configOpex->getFasesItemplan($idSubproyecto,$info_fase['faseDesc']);
