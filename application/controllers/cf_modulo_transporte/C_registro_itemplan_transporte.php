 ...
 *
 */
class C_registro_itemplan_transporte extends CI_Controller {
	...
	function __construct(){
        ...
        $this->load->model('mf_transporte/m_registro_itemplan_transporte');
	...
	{  	   
	    ...
	    if($logedUser != null){
            $data['listaProy'] = $this->m_utils->getAllProyectoTransporte();
            ...
            $result = $this->lib_utils->getHTMLPermisos($permisos, 309, 310, 8);
            $data['opciones'] = $result['html'];
            $this->load->view('vf_modulo_transporte/v_registro_itemplan_transporte',$data);
    ...
    public function registroItemplanTransporte(){
        ...
        try{
            ...
            $flgTransporte = 1;
             $fase = $this->m_utils->getCodigoFase(ANIO_ACTUAL);
            ...
            $data = $this->m_registro_itemplan_transporte->insertarPlanobraTrans($itemplan,$idProy, $idSubproy, $idCentral, $idzonal, $eecc, $eelec, $estadoplan, $fase, $fechaInicio, $nombreplan,$indicador,$itemplanPE, $flgTransporte);
