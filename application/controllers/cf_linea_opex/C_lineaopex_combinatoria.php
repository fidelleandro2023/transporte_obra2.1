...
class C_lineaopex_combinatoria extends CI_Controller {

	function __construct(){
        parent::__construct();
        $this->output->set_header('Content-Type: text/html; charset=ISO-8859-1');
        $this->load->model('mf_lineaopex/m_linea_opex_combinatoria');
    ...
    public function index(){
	    ...
	    if($logedUser != null){
               ...
               $data['tablaSiom']     = $this->getTablaSiom($this->m_linea_opex_combinatoria->getPepBolsaList("", "", "",""));               
               ...
               $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PERMISO_PADRE_ADMINISTRATIVO_PRESUPUESTO, 326, ID_MODULO_ADMINISTRATIVO);
               $data['opciones'] = $result['html'];
        	   if($result['hasPermiso'] == true){
        	         $this->load->view('vf_lineaopex/v_linea_opex_combinatoria',$data);
        	   }else{
    ...
    function filtrarTabla() {
        ...
        try {
            ...
            $data['tablaBolsaPep'] = $this->getTablaSiom($this->m_linea_opex_combinatoria->getPepBolsaList($idProyecto, $idSubProyecto, $pep1, $pep2));
            $data['error'] = EXIT_SUCCESS;
        } catch(Exception $e) {
            $data['msj'] = $e->getMessage();
        }
        ...
        $html = '<table id="data-table" class="table table-bordered">
                    <thead class="thead-default">
                        <tr>
                            ...
                            <th style="text-align: center;">AREA FUNCIONAL</th>
    ...
    public function saveTableOpex() {
        ...
        try {
            ...
            $data = $this->m_linea_opex_combinatoria->saveConfigOpex($arrayDataOP,$inputCecoAdd,$inputCuentaAdd,$inputAreaFuncional);
    ...
    function addLineaOpex() {
        ...
        try {
            ...
            $data = $this->m_linea_opex_combinatoria->addLinea($arrayData);
    ...
    function tipoMargen() {
        ...
        try {
            ...
            $data = $this->m_linea_opex_combinatoria->tipoMargen($idPepBolsa, $arrayData,$pep,$tipo);
            //$data['tablaBandejaSiom'] = $this->getTablaSiom();
            $data['error'] = EXIT_SUCCESS;
        } catch(Exception $e) {
            $data['msj'] = $e->getMessage();
