 ...
 *
 */
class C_tranferencia_sap_fija extends CI_Controller {

	function __construct(){
        parent::__construct();
        $this->output->set_header('Content-Type: text/html; charset=ISO-8859-1');
        $this->load->model('mf_tranferencias/m_tranferencia_sap_fija');
	...
	public function index(){
	    ...
	    if($logedUser != null){    	       
               ...
               $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PERMISO_PADRE_NUEVO_MODELO_TRANSFERENCIAS, ID_PERMISO_HIJO_TRANFERENCIA_SAP_FIJA, ID_MODULO_PAQUETIZADO);
               $data['opciones'] = $result['html'];
        	   if($result['hasPermiso'] == true){
        	         $this->load->view('vf_tranferencias/v_tranferencia_sap_fija',$data);
        	   }else{
    ...
    public function uploadSj1(){
        ...
        try{
            ...
            if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadfile)) {
                ...
                $dataf = $this->readFileSapFija($uploadfile,PATH_FILE_UPLOAD_SAP_FIJA_EDIT);          
                if($dataf['error'] == 1){
    ...
    function addRow($initPos, $comp, $file2,$countTmp){
        ...
        public function uploadSj2(){
            ...
            try{
                ...
                $data = $this->m_tranferencia_sap_fija->loadDataImportSapFija(PATH_FILE_UPLOAD_SAP_FIJA_EDIT);               
