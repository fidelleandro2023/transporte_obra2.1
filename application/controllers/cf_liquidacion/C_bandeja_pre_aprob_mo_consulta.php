 ...
 *
 */
class C_bandeja_pre_aprob_mo_consulta extends CI_Controller {
	...
	{  	   
	    ...
	    if($logedUser != null){
        	   ...
        	   $result = $this->lib_utils->getHTMLPermisos($permisos, ID_PERMISO_PADRE_BANDEJAS, ID_PERMISO_HIJO_CON_BANDEJA_PRE_CERTIFICACION);
        	   $data['opciones'] = $result['html'];
        	   if($result['hasPermiso'] == true){
        	       $this->load->view('vf_liquidacion/v_bandeja_pre_aprob_mo_consulta',$data);
        	   }else{
