...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>OBRAS PENDIENTES DE PAGOS</h2>
                    <div class="card">		   				                    
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link attSol" onclick="validarSolicitud();">Aceptar</button>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_liquidacion_mo/js_control_presupuestal_mo.js?v=<?php echo time();?>"></script>
