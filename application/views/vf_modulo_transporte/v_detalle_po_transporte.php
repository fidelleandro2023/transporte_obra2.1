...
<main class="main">
    ...
    <section class="content content--full">
        <div class="content__inner">
            ...
            <!-- Modal info -->
            <d iv class="modal fade" id="modal-info" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title pull-left">Informaci&oacute;n Planta Interna</h5>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="text-center" style="background-color: #1B84AC; color: white; padding: 2px">SAP</h6>
                                    <div class="card">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th style="font-size:12px;">PRESUPUESTO</th>
                                                <th style="font-size:12px;">REAL</th>
                                                <th style="font-size:12px;">COMPROMETIDO</th>
                                                <th style="font-size:12px;">PLAN RESORD</th>
                                                <th style="font-size:12px;">DISPONIBLE</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
...
<script type="text/javascript">
  ...
  $('#modal-editar').keyup(function(e) {
    ...
    function getPtr(component) {
        ...
        $.ajax({
            type: 'POST',
            'url': 'getDetallePoInfo',
            data: {
                ptr: ptr
            },
            'async': false
        }).done(function (data) {
              console.log('volvio de infowebPi');
            var data = JSON.parse(data);
