...
<!-- Mirrored from byrushan.com/projects/material-admin/app/2.0/jquery/bs4/hidden-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jul 2017 17:16:44 GMT -->
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>LIQUIDACI&Oacute;N DE OBRA</h2>
                    <div class="card">		   				                    
                        ...
                        <div class="card-block"> 
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <button style="margin-top: 30px;" class="btn btn-success waves-effect" type="button" onclick="filtrarTablaLiqui();">CONSULTAR</button>
                                </div>  
                            </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/fancy/source/jquery.fancybox.js?v=<?php echo time();?>"></script>
        <script src="<?php echo base_url();?>public/js/js_modulo_transporte/jsLiquidacionObraTransporte.js?v=<?php echo time();?>"></script>
