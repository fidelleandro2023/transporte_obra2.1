...
<html lang="en">
    ...
    <body data-ma-theme="entel">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <label>PEP</label>
                                        <input id="pep" name="pep" type="text" class="form-control input-mask" data-mask="P-0000-00-0000-00000" placeholder="P-0000-00-0000-00000">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <button class="btn btn-success waves-effect" onclick="consulta_pep()">CONSULTAR</button>
                                    </div> 
                                </div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_presupuesto/jsPep.js?v=<?php echo time(); ?>"></script>
