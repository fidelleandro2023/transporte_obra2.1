                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-8" >
                                        <div class="form-group">
                                            ...
                                            <label><input type="checkbox" id="id_pep2" value="id_pep2" onclick="pep2_automatico()"> Ingresar PEP2</label><br>

                                        </div>
                                    </div>
									-->
                                    <div class="col-sm-12 col-md-8" style="display:none" id="ctn_pep2">
                                        <div class="form-group">
                                            <label>PEP2</label>
                                            <input type="text" class="form-control" id="dato_pep2" name="dato_pep2"><br>
                                            </select>
                                        </div>
                                    </div>
