...
<html lang="en">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2 style="color: #333333d4;font-weight: 800;text-align: center;"><?php echo $title ?></h2>
                    <div class="">  
                        <div class="card" style="">
                            <div class="card-block">
                                <div id="contTablaMatriz" class="table-responsive">
                                    <?php echo $tablaMatriz ?>
                                </div>
                            </div>
                        </div>
                    </div>    
            ...
            <div class="modal fade" id="modalBandaHoraria" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                    <div class="modal-header" style="background:#3b5998;height:70px">
                        <h5 class="modal-title" style="color:white">Registrar Cuotas</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="contCmbBandaHoraria" class="form-control">
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="registrarCuotas();">Aceptar</button>
                    </div>
                    </div>
                </div>
            </div>
            
            <div class="modal fade" id="modaEditarCuotas" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                    <div class="modal-header" style="background:#3b5998;height:70px">
                        <h5 class="modal-title" style="color:white">Editar Cuotas</h5>
                        <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"> -->
                        <!-- <span aria-hidden="true">&times;</span>
                        </button> -->
                    </div>
                    <div class="modal-body">
                        <div id="contEditar" class="row">

                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-primary" onclick="actualizarCuotas();">Aceptar</button>
                    </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo base_url();?>public/js/js_agendamiento/jsMatrizAgendamiento.js?v=<?php echo time();?>"></script>
