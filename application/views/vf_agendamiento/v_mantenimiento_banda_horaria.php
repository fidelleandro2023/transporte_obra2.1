...
<html lang="en">
    ...
    <body data-ma-theme="entel">
        <main class="main">
                    ...
                    <div class="container" align="center">  
                        <div class="card col-md-10">
                            <div class="card-block">
                                <div>
                                    <div class="text-left">
                                        <button class="btn btn-success" onclick="openModalRegistrarBandaHoraria()">Registrar Banda Horaria</button>
                                    </div>
                                </div>
                                <div id="contTablaBandaHoraria" class="table-responsive">
                                    <?php echo $tablaBandaHoraria ?>
                                </div>
                            </div>
                        </div>
                    </div>    
            ...
            <div class="modal fade" id="modalRegistrarBandaHoraria" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div class="modal-content">
                    <div class="modal-header" style="background:red;height:70px">
                        <h5 class="modal-title" style="color:white">REGISTRAR BANDA HORARIA</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input id="idHoraInicio" class="form-control" type="time">
                            </div>
                            <div class="col-md-6">
                                <label>Hora Fin</label>
                                <input id="idHoraFin" class="form-control" type="time">
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="registrarBandaHoraria()">Aceptar</button>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="modalAlertaAceptacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-primary" onclick="eliminarBandaHoraria()">Aceptar</button>
                    </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo base_url();?>public/js/js_agendamiento/jsMantenimientoBandaHoraria.js?v=<?php echo time();?>"></script>
