...
<html lang="en">
                    ...
                    <div class="">    
                        <div class="card" style="">
                            <div class="card-block">
                                <div id="contTablaAgendamiento" class="table-responsive">
                                    <?php echo $tablaAgendamiento ?>
                                </div>
                            </div>
                        </div>
                    </div>    
            ...
            <div class="modal fade" id="modalAlertaAceptacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    ...
                    <div class="modal-body">
                        <a>Al aceptar, se confirmar&aacute; la fecha de agendamiento y ya no podr&aacute; modificarlo.
                           Si desea modificarlo vaya a la columna "fecha Agendamiento", modifique este y luego confirme</a>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <button id="btnAceptarFormulario" type="button" class="btn btn-primary" onclick="confirmarAgendamiento();">Aceptar</button>
                    </div>
                    </div>
                </div>
            </div>

            <div class="modal fade" id="modalAlertaCancelacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div class="modal-content">
                    <div class="modal-header" style="background:red;height:70px">
                        <h5 class="modal-title" style="color:white">&#191;EST&Aacute; SEGURO DE REALIZAR ESTA ACCI&Oacute;N?</h5>
                    ...
                    <div class="modal-body">
                        <a>Al aceptar, se cancelar&aacute; la fecha de agendamiento</a>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <button id="" type="button" class="btn btn-primary" onclick="confirmarCancelacion();">Aceptar</button>
                    </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo base_url();?>public/js/js_agendamiento/jsConfirmarAgendamiento.js?v=<?php echo time();?>"></script>
