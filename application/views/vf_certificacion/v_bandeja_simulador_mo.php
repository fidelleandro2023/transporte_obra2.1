...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>SIMULADOR PRESUPUESTO MO</h2>
                    <div class="card">		   				                    
                        ...
                        <div class="card-block"> 
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label>SIN DECLARACION JURADA</label>
                                        <select id="selectSDJ" name="selectSDJ" class="select2">                                            
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label>CON DECLARACION JURADA</label>
                                        <select id="selecCDJ" name="selecCDJ" class="select2">
                                            <option selected value="1">SI</option>
                                            <option value="">NO</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label>CON EXPEDIENTE</label>
                                        <select id="selectCExpe" name="selectCExpe" class="select2">
                                            <option selected value="1">SI</option>
                                            <option value="">NO</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="selectValid" name="selectValid" class="select2">
                                            <option selected value="1">SI</option>
                                            <option value="">NO<option>
                                        </select>
                                    </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                        <div class="form-group">
                                            <label>CESTA</label>
                                            <input disabled id="txtCestaCa" name="txtCestaCa" type="text" class="form-control input-mask" style="border-bottom: 1px solid lightgrey">
                                        </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_certificacion/jsBandejaSimuladorMo.js?v=<?php echo time();?>"></script>
