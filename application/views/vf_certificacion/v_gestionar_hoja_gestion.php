...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>GESTIONAR HOJA DE GESTION</h2>
                    <div class="card">		   				                    
                        ...
                        <div class="card-block"> 
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label>HOJA GESTION</label>
                                        <input id="txtHojaGestion" type="text" class="form-control input-mask" placeholder="Hoja Gestion" autocomplete="off" maxlength="13" style="border-bottom: 1px solid lightgrey">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label>CODIGO PO</label>
                                        <input id="txtCodigoPo" type="text" class="form-control input-mask" placeholder="Codigo PO" autocomplete="off" maxlength="16" style="border-bottom: 1px solid lightgrey">
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<div id="contCertificacion">
						<div class="tab-container form-group">
							<ul class="nav nav-tabs nav-fill" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="#certificar" role="tab">CERTIFICACI&Oacute;N</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#detalleLOG" role="tab">LOG PO REMOVIDAS</a>
								</li>
							</ul>
						</div><!-- fin tab container -->
						<div class="tab-content">
							<div class="tab-pane active fade show" id="certificar" role="tabpanel">
								<form id="formCargaOC" method="post" class="form-horizontal">
									<div class="form-group">
										<div class="row">
											<div class="col">
													<div class="form-group">
														<label>CESTA</label>
														<input id="txtCestaCa" name="txtCestaCa" type="text" class="form-control input-mask" style="border-bottom: 1px solid lightgrey">
													</div>
											</div>
											<div class="col">
												<div class="form-group">
													<label>ORDEN DE COMPRA</label>
													<input id="txtOrdenCompra" name="txtOrdenCompra" type="text" class="form-control input-mask" placeholder="Orden de Compra" autocomplete="off" maxlength="20" style="border-bottom: 1px solid lightgrey">
												</div>
											</div>
											<div class="col">
												<div class="form-group">
													<label>NRO CERTIFICACION</label>
													<input id="txtNroCertificacion" name="txtNroCertificacion" type="text" class="form-control input-mask" placeholder="Nro Certificacion" autocomplete="off" maxlength="20" style="border-bottom: 1px solid lightgrey">
												</div>
											</div>  
											 
											 <div class="col" id="contBtnAsignarOC">
												<div class="form-group" style="padding-top: 25px;" >
													<div class="col-sm-12">
														<button id="btnAsignarOC" type="submit" class="btn btn-primary">Asignar OC</button>
													</div>
												</div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_certificacion/jsGestionarHojaGestion.js?v=<?php echo time();?>"></script>
