        ...
        <main class="main">
            ...
            <section class="content content--full">
                ...
                <div class="content__inner">
                    <h2>ACTUALIZACION MASIVA DE CREACION OC OPEX</h2>
                    ...
                    <div class="card-block">	
                        <div class="form-group col-sm-12" style="text-align: center;">		<!--		
                            ...
                            <label style="color: red" class="control-label mb-10 text-left">Llenar la columna "CODIGO SOLICITUD", "CESTA", "ORDEN DE COMPRA", "COSTO SAP" archivo solicitud_oc.xlsx y cargarlo para su proceso.</label>
                        </div>
                        <div class="row">
   ...
   <!--  tables -->
        ...
        $('#preLoadFile').click(function(e){
            ...
            if(listaFileValido!=null && listaFileValido.length>0){
            	...
            	swal({
                    title: 'Esta de atender las solicitudes OC?',
                    ...
                    allowOutsideClick: false
                        ...
                        $.ajax({
                            type: 'POST',
                            'url': 'atencionMasivoSolicitudOcOpex',
                            data: form_data,
                            cache: false,
                            contentType: false,
                            processData: false,
                        		...
                        		setTimeout(
                      				  function() 
                      				  {
                                    		...
                                    		swal({
                                                ...
                                                window.location.href = "getAtencionMasivoOpex";
                                            });
