...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/bower_components/bootstrap-validator/bootstrapValidator.min.css?v=<?php echo time(); ?>">
    </link>
    <!-- App styles -->
...
<body data-ma-theme="entel">
    <main class="main">
        ...
        <section class="content content--full">
            <div class="content__inner">
                <h2>GESTI&Oacute;N ORDEN DE COMPRA</h2>
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="txtSolicitud" type="text" class="form-control input-mask" placeholder="Solicitud" autocomplete="off" maxlength="13" style="border-bottom: 1px solid lightgrey">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="tab-container">
                            <ul class="nav nav-tabs nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#detalleObra" role="tab">DETALLE OBRA</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#detallePO" role="tab">DETALLE PO</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane active fade show" id="detalleObra" role="tabpanel">
                                <div id="contTablaSiom">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="detallePO" role="tabpanel">
                                <div class="tab-container">
                                    <div id="conTablaDetallePO" class="table-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modaldQuiebre" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 style="margin: auto; font-weight: bold;" class="modal-title">SUSPENDER SOLICITUD</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id='txtCodigoSolicitud' />
                    <div class="form-group">
                        <label>Seleccionar Motivo</label>
                        <div class="input-group">
                            <div class="form-group">
                                <select id="contCmbMotivo" class="select2"></select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button style="BACKGROUND-COLOR: #183469; COLOR: WHITE;" onclick="enviarQuiebreSolOc();" type="button" class="btn btn-link waves-effect">Guardar</button>
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url(); ?>public/js/js_certificacion/jsCreacionOC.js?v=<?php echo time(); ?>"></script>
