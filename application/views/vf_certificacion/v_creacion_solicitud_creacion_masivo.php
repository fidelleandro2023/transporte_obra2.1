        ...
        <main class="main">
            ...
            <section class="content content--full">
		                   ...
		                   <div class="content__inner">
                            <h2>SOLICITUD DE CREACION OC MASIVO</h2>
            ...
            <div class="card-block">	
                <div class="form-group col-sm-12" style="text-align: center;">		<!--		
					...
					<label style="color: red" class="control-label mb-10 text-left">Llenar la columna "ITEMPLAN", "COSTO MO", "PEP 1" archivo solicitud_oc.xlsx y cargarlo para su proceso.</label>
				</div>
				 <div class="row">
                        	...
                        	if(data.error == 0){
                        		setTimeout(
                      				  function() 
                      				  {
                        					$('#modalProgreso').modal('toggle');
                                    		swal({
                                                title: 'Se proceso correctamente la informacion! ',
                                                text: 'Valide los resultados obtenidos en el campo "Observacion"!',
                                                type: 'success',
                                                buttonsStyling: false,
                                                confirmButtonClass: 'btn btn-primary',
                                    		...
                                    		$('#contTabla').html(data.html_table);  
            		         	    		initDataTable('#data-table');
