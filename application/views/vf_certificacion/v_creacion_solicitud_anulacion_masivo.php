        ...
        <main class="main">
            ...
            <section class="content content--full">
		                   ...
		                   <div class="content__inner">
                            <h2>CREACION DE SOLICITUD DE ANULACION OC MASIVO</h2>
            ...
            <div class="card-block">	
                <div class="form-group col-sm-12" style="text-align: center;">		<!--		
					...
					<label style="color: red" class="control-label mb-10 text-left">Llenar la columna "ITEMPLAN" archivo solicitud_oc.xlsx y cargarlo para su proceso.</label>
				</div>
				 <div class="row">
                        		...
                        		setTimeout(
                      				  function() 
                      				  {
                                    		...
                                    		swal({
                                                ...
                                                window.location.href = "upMasiCreOcAnul";
                                            });
