    ...
    <main class="main">
        ...
        <section class="content content--full">
            ...
            <div class="content__inner">
                <h2>ACTUALIZACION MASIVA DE EDICION OC OPEX</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="form-group col-sm-12" style="text-align: center;">
                            ...
                            <label style="color: red" class="control-label mb-10 text-left">Llenar la columna "CODIGO SOLICITUD", "ORDEN DE COMPRA", "COSTO SAP" archivo solicitud_oc.xlsx y cargarlo para su proceso.</label>
                        </div>
                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        $('#preLoadFile').click(function(e) {
            ...
            if (listaFileValido != null && listaFileValido.length > 0) {
                ...
                swal({
                    title: 'Est� seguro generar atender las solicitudes OC?',
                            ...
                            setTimeout(
                                function() {
                                    ...
                                    swal({
                                        ...
                                        window.location.href = "getEdicionMasivoOpex";
                                    });
