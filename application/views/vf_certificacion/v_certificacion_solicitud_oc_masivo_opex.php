    ...
    <main class="main">
        ...
        <section class="content content--full">
            ...
            <div class="content__inner">
                <h2>ACTUALIZACION MASIVA DE CERTIFICACION OC</h2>
        ...
        function procesarFile(component) {
            ...
            if (comprobar > 0) {
                ...
                if (ext != ".xls" && ext != ".xlsx") {
                    ...
                    $.ajax({
                        url: "procesarCertificacionOpexMasivo",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
        ...
        $('#preLoadFile').click(function(e) {
            ...
            if (listaFileValido != null && listaFileValido.length > 0) {
                swal({
                    ...
                    $.ajax({
                        type: 'POST',
                        'url': 'atencionCertificacionOpexMasivo',
                        data: form_data,
                        cache: false,
                        contentType: false,
                        processData: false,
                            ...
                            setTimeout(
                                function() {
                                    ...
                                    swal({
                                        ...
                                        window.location.href = "getCertificacionMasivoOpex";
                                    });
