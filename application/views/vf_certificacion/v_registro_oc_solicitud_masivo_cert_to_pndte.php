        ...
        <main class="main">
            ...
            <section class="content content--full">
		                   ...
		                   <div class="content__inner">
                            <h2>ACTUALIZACION MASIVA DE SOL. CERTIFICACION (PNDT DE ACTA > PENDIENTE)</h2>
                           <div class="col-sm-12 col-md-12" style="text-align: right;">
                                    <button class="btn btn-success waves-effect" type="button" onclick="backMenu()" style="border-radius: 30px;">VOLVER AL MENU</button>                     
                            </div>         
            <div class="card">
            ...
            <div class="card-block">	
                <div class="form-group col-sm-12" style="text-align: center;">		<!--		
					...
					<label style="color: red" class="control-label mb-10 text-left">Descargue el Formato de solicitud_oc.xlsx</label><br>
					<label style="color: red" class="control-label mb-10 text-left">Llenar la columna "CODIGO SOLICITUD", "CODIGO DE CERTIFICACION" archivo solicitud_oc.xlsx y cargarlo para su proceso.</label>
				</div>
				 <div class="row">
                    ...
                    <div class="form-group col-md-4" style="text-align: center;">                        
                        <input type="button" id="preLoadFile" value="3) Asignar OC" class="btn-success">
                    </div>  
                    <!-- 
                    <div class="form-group col-md-2" style="text-align: right">
   ...
   <!--  tables -->
    		            ...
    		            $.ajax({
    		                ...
    		                success: function(response){
    		                    ...
    		                    if(data.error == 0){  
    		         	    		...
    		         	    		console.log('listaFileValido:'+fileValido);
        ...
        $('#preLoadFile').click(function(e){
            ...
            if(listaFileValido!=null && listaFileValido.length>0){
            	...
            	swal({
                    title: 'Está seguro generar atender las solicitudes OC?',
                        		...
                        		setTimeout(
                      				  function() 
                      				  {
                                    		...
                                    		swal({
                                                ...
                                                window.location.href = "upMasiOcToPenCert";
                                            });
