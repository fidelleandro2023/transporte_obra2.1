...
<html lang="en">
                                ...
                                <div class="table-responsive">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label>Exportar Kit Material</label>
    ...
    <script src="<?php echo base_url();?>public/js/js_po/registro_individual_po.js?v=<?php echo time();?>"></script>
    
<script>
   var fromGlob 	  = <?php echo ($form)?>;
   var itemplanGlob   = <?php echo ($item)?>;
   var idEstacionGlob = <?php echo ($idEstacion)?>;
