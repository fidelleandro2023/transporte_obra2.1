...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
        ...
        $(document).ready(function() {
            ...
            $('#formAddSubPep').bootstrapValidator({
                container: '#messages',
                feedbackIcons: {
                ...
                fields: {
                	selectSubProy2: {
                        validators: {
                            notEmpty: {
                                message: 'The subproyecto name is required and cannot be empty'
                            }
                        }
                    },
                    selectArea: {
                    ...
                    inputPep: {
                        validators: {
                            notEmpty: {
                                message: 'The pep name is required and cannot be empty'
                            }
                        }
                    }
