    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
             ...
             <h2 style="color: #333333d4;font-weight: 800;text-align: center;">TRANFERENCIA SAP COAXIAL</h2>
              <div class="card">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-115313781-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-115313781-1');
</script>
        <!-- Vendors -->
