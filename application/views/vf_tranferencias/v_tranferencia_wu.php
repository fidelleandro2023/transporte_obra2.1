 ...
 <?php include('application/views/v_opciones.php'); ?>
            ...
            <section class="content content--full">
             <div class="content__inner">
                <h2>TRANFERENCIA WEB UNIFICADA</h2>
              <div class="card">
  ...
  <label style="font-size: smaller;text-align: left;">- La estructura del archivo debe contar con 35 columnas separados por Tabulaciones.</label>
                                    <br><br>
<div id="contProgres">
                                ...
                                <span id="valuePie" class="easy-pie-chart__value">0</span>
                                     ...
                                     <form id="subida">
                                        <table style="margin: auto;">
                                            ...
                                            <tr>
                                            	<td><input id="btnIniTransfeWU" type="submit" value="Send File" style="background-color: var(--verde_telefonica); display: block;"/></td>
                                            </tr>
                                                <td><button id="btnGenerarArchivos" class="btn btn-success waves-effect"  style="background-color: var(--verde_telefonica); display: none;" type="button" onclick="generarArchivosCSV()">Comenzar Generacion de Archivos</button></td>
                                            <tr>
                                            </tr>
                                            <tr>
                                            	<td id="respuesta"></td>
