...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
                        ...
                        <div class="card-block">	   				                         
                            <div class="row">
                                <section>
                                    ...
                                    <label style="font-size: smaller;text-align: left;">- Puede descargar un ejemplo de la estructura.</label><a href="download/modelos/ejemplo_transferencia_siom.xlsx" >Aqu&iacute;</a><br>
                                    <label style="font-weight: bold;color: red;font-size: smaller;text-align: left;">- Se debe ingresar el c&oacute;digo siom de manera obligatoria.</label><br>
                                    <label style="font-weight: bold;color: red;font-size: smaller;text-align: left;">- Si se genera alguna alerta comunicarse con el programador.</label>
                                    <div id="contProgres">
        ...
        <script src="<?php echo base_url();?>public/js/js_transferencia/jsTransferenciaSiom.js?v=<?php echo time();?>"></script>  
