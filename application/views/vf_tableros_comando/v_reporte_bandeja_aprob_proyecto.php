 ...
 <?php include('application/views/v_opciones.php'); ?>
            ...
            <section class="content content--full">
             	<div class="content__inner" style="/*max-width: 100%;*/">
             		<h2 >TABLERO DE COMANDO - BANDEJA APROBACION POR PROYECTO</h2>
              		<div class="card">
            ...
            <div class="modal fade"  id="modalDetallePtr" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                             <div id="contTablaSiom" class="table-responsive">
                              </div>                 
                    </div>
        ...
        var dataGeneralPie =  <?php echo json_encode($listaDataPie)?>;
        var totalPoGlobal   =   <?php echo $totalPos?>;
        </script>
  	    <script src="<?php echo base_url();?>public/js/js_tableros_comando/reporte_bandeja_aprob_proyecto.js?v=<?php echo time();?>"></script>		
