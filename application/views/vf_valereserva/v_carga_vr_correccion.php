...
<h2 style="color: #333333d4;font-weight: 800;text-align: center;">CARGA CORRECCION VALE DE RESERVA</h2>
              <div class="card">
  ...
  <label style="font-size: smaller;text-align: left;">- La estructura del archivo debe contar con 5 columnas separados por Tabulaciones.</label>
                                    <br><br>
<div id="contProgres">
                                                        ...
                                                        url : 'upWUExtrVR'
                                                          ...
                                                          console.log(data);
                                                            ...
                                                            if(ERROR==0){
                                                                ...
                                                                $('#valuePie').html(100);
                                                                $('#respuesta').html('<label style="font-size: larger; padding-top: 20px;color: #0d7d3f;">Se ejecut&oacute; el proceso de correcci&oacute;n de Vale de Reserva <br>y la actualizaci&oacute;n en el extractor de manera satisfactoria.!</label>');
                                                             } 
