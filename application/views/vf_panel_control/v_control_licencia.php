...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
                            ...
                            <div class="card-block"> 
                                <div class="tab-container">
                                    <ul class="nav nav-tabs nav-fill" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#po_valida" role="tab">PO A VALIDAR</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#sin_po" role="tab">LIC. GESTI&Oacute;N SIN PO</a>
                                        </li>  
                                    </ul>
                                </div>
                                <div class="tab-content">
                                    <div class="tab-pane fade active fade show" id="po_valida" role="tabpanel">
                                        <div id="contTablaSinValidado" style="display:none;" class="table-responsive form-group col-md-12">
                                            <?php echo (isset($tablaSinPo) ?  $tablaSinPo : null ) ?>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="sin_po" role="tabpanel">
                                        <div id="contTablaSinPo" style="display:none;" class="table-responsive form-group col-md-12">
                                            <?php echo (isset($tablaSinEstadoValidado) ?  $tablaSinEstadoValidado : null )   ?>
                                        </div>
                                    </div>
                                </div>               
                            </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_panel_control/js_control_licencia.js?v=<?php echo time();?>"></script>
