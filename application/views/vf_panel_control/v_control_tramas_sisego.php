...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label>TIPO</label>
                                        <select id="selectTipoTrama" name="selectTipoTrama" class="select2 form-control">
                                            <option value="">&nbsp;</option>
                                            <option value="1">TRAMA CREAR ITEMPLAN</option>
                                            <option value="2">TRAMA APROBACI&Oacute;N</option>
                                            <option value="3">TRAMA COTIZACI&Oacute;N</option>
                                            <option value="4">TRAMA LIQUIDACI&Oacute;N OBRA</option>                                          
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label>&Eacute;XITO / NO &Eacute;XITO</label>
                                        <select id="selectExito" name="selectExito" class="select2 form-control">
                                            <option value="">&nbsp;</option>
                                            <option value="1">&Eacute;XITO</option>
                                            <option value="2">NO &Eacute;XITO</option>                                         
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <buttom class="btn btn-success" onclick="filtrarTablaTramaSisego();">Consultar</buttom>
                                </div>
                            </div>
                            <div id="contTabla" class="table-responsive">
                                <?php echo !isset($tablaTramas) ? '' : $tablaTramas; ?>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_panel_control/js_control_tramas_sisego.js?v=<?php echo time();?>"></script> 
