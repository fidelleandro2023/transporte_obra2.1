...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
                            ...
                            <div class="card-block"> 
                                <div class="tab-container">
                                    <ul class="nav nav-tabs nav-fill" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#sin_po" role="tab">DISE&Ntilde;O EJEC. SIN PO</a>
                                        </li>  
                                    </ul>
                                </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_panel_control/js_control_diseno.js?v=<?php echo time();?>"></script>
