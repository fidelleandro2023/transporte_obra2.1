        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>CARGA CÓDIGO ÚNICO</h2>
                    <hr>
                    <div class=""> 
                        <div class="card"  align="center">
                            <div class="card-block">
								<div class="tab-pane active fade show" align="center" id="tab_registro" role="tabpanel">
									<label style="font-size: smaller;text-align: left;">- La estructura del archivo debe  estar en formato .xls o .xlsx(Excel).</label><br>
									<label style="font-size: smaller;text-align: left;">- Puede descargar un ejemplo de la estructura.</label><a href="download/modelos/ejemplo_upd_planobra.xlsx" >Aqu&iacute;</a><br>
			...
			$('#import_form').on('submit', function(event){
				...
				$.ajax({
                            ...
                            if(data.error == 0) {
                                ...
                                $('#contTablaItems').html(data.tablaItem);
                                initDataTable('#data-table');
                            } else {
                                mostrarNotificacion('info','Verificar', 'error, no se registraron los itemplans');
                            }
