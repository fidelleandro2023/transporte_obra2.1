                    ...
                    <form id="formEditCentral" method="post" class="form-horizontal"> 
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                         <label>TIPO CENTRAL</label>
                                                <select id="selectTipoCentral2" name="selectTipoCentral2" class="select2 form-control" disabled="disabled">
                                                    <option>&nbsp;</option>
                                                      <?php                                                    
                                                            foreach($listaTiCen->result() as $row){                      
                                                        ?> 
                                    ...
                                    <div id="contInputCorreP" class="form-group has-feedback" style="">
                                        <label>DESCRIPCION</label>
                                        <input id="inputDescripcion2" name="inputDescripcion2" type="text" class="form-control" disabled="disabled"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" style="display: none;"></i>
                                        <i class="form-group__bar"></i>
                                    </div>
                                    <div id="contInputCorreP" class="form-group has-feedback" style="">
                                        <label>CODIGO</label>
                                        <input id="inputCodigo2" name="inputCodigo2" type="text" class="form-control" disabled="disabled"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" style="display: none;"></i>
                                        <i class="form-group__bar"></i>
                                    </div>
                                    <div class="form-group">
                                         <label class="control-label">ZONAL</label>
                                                <select id="selectZonal2" name="selectZonal2" class="select2 form-control" disabled="disabled">
                                                    <option>&nbsp;</option>
                                                    <?php                                                    
                                                            foreach($listazonas->result() as $row){                      
                                                        ?> 
                                ...
                                <div class="col-sm-6 col-md-6">
                                        ...
                                        <div id="contInputCorreP" class="form-group has-feedback" style="">
                                            ...
                                            <select id="cmbJefatura" name="cmbJefatura" class="select2 form-control" disabled="disabled">
                                            </select>
                                        </div>
                                        <div id="contInputCorreP" class="form-group has-feedback" style="">
                                            <label>REGION</label>
                                            <input id="inputRegion2" name="inputRegion2" type="text" class="form-control" disabled="disabled"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" style="display: none;" ></i>
                                            <i class="form-group__bar"></i>
                                        </div>
                                </div>
                            </div>
   ...
   <!--  tables -->
        ...
        function editCentral(component){
        	...
        	.bootstrapValidator({
                ...
                var cmbJefatura = $('#cmbJefatura option:selected').val();
                var selectTipoCentral2 = $('#selectTipoCentral2 option:selected').val();
                var inputDescripcion2 = $('#inputDescripcion2').val();
                var inputCodigo2 = $('#inputCodigo2').val();
                var selectZonal2 = $('#selectZonal2 option:selected').val();
                var selectEECC2 = $('#selectEECC2 option:selected').val();
                var inputJefatura2 = $('#inputJefatura2').val();
                var inputRegion2 = $('#inputRegion2').val();

                formData.append('cmbJefatura', cmbJefatura);
                formData.append('selectTipoCentral2', selectTipoCentral2);
                formData.append('inputDescripcion2', inputDescripcion2);
                formData.append('inputCodigo2', inputCodigo2);
                formData.append('selectZonal2', selectZonal2);
                formData.append('selectEECC2', selectEECC2);
                formData.append('inputJefatura2', inputJefatura2);
                formData.append('inputRegion2', inputRegion2);
