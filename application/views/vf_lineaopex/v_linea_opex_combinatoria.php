                        ...
                        <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <button class="btn btn-success waves-effect" onclick="agregarCuentaOpex()">NUEVA CONFIGURACION</button>
                                    </div> 
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title text-center">NUEVA CONFIGURACION DE COMBINATORIAS</h1>
                    </div>
                    <br>
