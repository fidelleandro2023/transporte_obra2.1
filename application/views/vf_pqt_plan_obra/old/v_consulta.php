                        ...
                        <form id="formRegistrarEvidenciasSinSiom" method="post" style="padding-right: inherit;padding-left: inherit;padding-bottom: inherit;">
                           <div class="row">
                                <div class="form-group col-sm-6 col-xs-6">
                                 	<label style="font-weight: bold;font-size: x-small;" class="control-label mb-10 text-left">PRIMER DOC.(PDF)</label>
                                    <input id="filePruebasRefleESinSiom" name="filePruebasRefleESinSiom" type="file" accept="application/pdf">
                                </div>  
                                 <div class="form-group col-sm-6 col-xs-6">
                                 	<label style="font-weight: bold;font-size: x-small;" class="control-label mb-10 text-left">SEGUNDO DOC.(PDF)</label>  
		...
		function calcularCostoFinal() {
			...
			for(var i=1; i<count; i++) {
				...
				if(!isNaN(cantidadFin)) {
					if(cantidadFin == null || cantidadFin == '') {
						console.log("eNTRO11");
						total = Number($('#costoTotal_'+i).html());
						console.log("eNTRO11");
						console.log(total);
