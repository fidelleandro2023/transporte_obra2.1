...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>BANDEJA DE EXCESOS OBRAS NUEVAS</h2>
                    <div class="card">		   				                    
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_control_presupuestal/jsBandejaControlPresupuestal.js?v=<?php echo time();?>"></script>
