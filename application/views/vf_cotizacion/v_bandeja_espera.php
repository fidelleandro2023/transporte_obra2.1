        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>BANDEJA DE ESPERA COTIZACI&Oacute;N</h2>
                    <hr>
                    <div class="card">	   				                    
...
<!--                            <div class="row">
                            ...
                            <div id="contTabla" class="table-responsive">
                                <?php echo isset($tablaConsulta) ? $tablaConsulta : null ?>
        ...
        <!--<script src="<?php echo base_url(); ?>public/js/js_planobra/jsEvaluarSisego.js?v=<?php echo time(); ?>"></script>-->
