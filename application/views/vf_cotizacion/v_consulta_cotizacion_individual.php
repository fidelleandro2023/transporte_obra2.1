...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label>SISEGO</label>
                                        <input id="sisego" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-sm-3 col-md-3">    
                                    <div class="form-group">
                                        <label>C&Oacute;DIGO COTIZACI&Oacute;N</label>
                                        <input id="codigo_form" class="form-control" />
                                    </div>
                                </div>
                                 <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
								...
								<div class="col-sm-12 col-md-3">    
                                    <div class="form-group">
                                        ...
                                        <input id="itemplanFiltro" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <buttom class="btn btn-success" onclick="filtrarTablaConsultaCotizacion();">Consultar</buttom>
                                </div>
                            </div>
                            <div id="contTabla" class="table-responsive">
                                <?php echo !isset($tablaAnalisisEconomico) ? '' : $tablaAnalisisEconomico; ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="modalDocumentosFom"  tabindex="-1">
                                ...
                                <div class="" id="contCardDetalleVR">
                                    <div class="" id="cntMsj">
                                        <table id="data-table" class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><div class="form-group col-md-6" id="contPerfil"></div></td>
                                                    <td><div class="form-group col-md-6" id="contSisego"></div></td>
                                                    <td><div class="form-group col-md-6" id="contRutas"></div></td>
                                                </tr>
                                            </tbody>
                                        </table>'
                                    </div>
                ...
                <div class="modal fade" id="modalLogCotizacion"  tabindex="-1">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="margin: auto;    font-weight: bold;" class="modal-title">LOG COTIZACI&Oacute;N</h4>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                            </div>
                            <div class="modal-body">
                                <div class="" id="contTablaLog">
				...
				<div class="modal fade bd-example-modal-lg" tabindex="-1" id="modalEditarCostos" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
							<div class="modal-header">
								<h3 class="modal-title">EDITAR COSTOS</h3>
								<h3 class="modal-title" id="totalCoti"></h3>
							</div>
							<div class="modal-body">
								<div class="form-group col-md-12">
									<div class="row">
										<div class="form-group col-md-6">
											...
											<input class="form-control" id="costoMat" onchange="calcularCostototal();" />
										</div>
										<div class="form-group col-md-6">
											<label>Costo Mat Edif.</label>
											<input class="form-control" id="costoMatEdif" onchange="calcularCostototal();" />
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label>Costo Oc Edif.</label>
											<input class="form-control" id="costoOcEdif" onchange="calcularCostototal();" disabled />
										</div>
										<div class="form-group col-md-6">
											<label>Costo Mo</label>
											<input class="form-control" id="costoMo" onchange="calcularCostototal();"/>
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label>Costo Dise&ntilde;o</label>
											<input class="form-control" id="costoMoDiseno" onchange="calcularCostototal();"/>
										</div>
										<div class="form-group col-md-6">
											<label>Costo EIA</label>
											<input class="form-control" id="costoEia" onchange="calcularCostototal();"/>
										</div>
									</div>
									
									<div class="row">
										<div class="form-group col-md-6">
											<label>Costo Adic. rural</label>
											<input class="form-control" id="costoAdicRural" onchange="calcularCostototal();"/>
										</div>
										<div class="form-group col-md-6">
											<label>Costo Oc</label>
											<input class="form-control" id="costoOc" onchange="calcularCostototal();" disabled />
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label>Total</label>
											<input class="form-control" id="totalCalculo" disabled />
										</div>
									</div>
								</div>
							</div>
							<div class="modal-footer">
								<button class="btn btn-success" onclick="actualizarCostosCotiPo();">Aceptar</button>
								<button class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
							</div>      
                        </div>
                    </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_cotizaciones/js_consulta_cotizacion_individual.js?v=<?php echo time();?>"></script> 
