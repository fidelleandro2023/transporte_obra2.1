...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>public/bower_components/nouislider/distribute/nouislider.min.css">
        <link rel="stylesheet" href="<?php echo base_url();?>public/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.css">
        <link rel="stylesheet" href="<?php echo base_url();?>public/bower_components/trumbowyg/dist/ui/trumbowyg.min.css">
                           ...
                           <h2>BANDEJA DE pre diseño</h2>
                                ...
                                <div class="col-sm-6 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select id="selectEstado" name="selectEstado" class="select2" onchange="filtrarTabla()">
                                             <option>&nbsp;</option>
...
<!-- Ignore backdrop click -->
                            <div class="modal fade" id="modal-adjudicar" data-backdrop="static" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title pull-left">ADJUDICACIÓN</h5>
                                        </div>
                                        <form id="subida">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group" >
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input id="fechaEntrega" type="text" class="form-control date-picker" placeholder="Seleccione fecha de entrega">
                                                                <i class="form-group__bar"></i>
                                                            </div>
                                                        ...
                                                        <div class="input-group">
                                                            <div class="form-group">
                                                                <input id="csv" name="userfile" type="file" />
                                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" class="btn btn-link" value="Send File" />
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/bower_components/nouislider/distribute/nouislider.min.js"></script>
        <script src="<?php echo base_url();?>public/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
        <script src="<?php echo base_url();?>public/bower_components/trumbowyg/dist/trumbowyg.min.js"></script>
        <!-- -->
        ...
        $(function(){
            ...
            $('#subida').submit(function(){
                ...
                console.log('comprobar es:'+comprobar);
                return false;
                /*
                if(comprobar>0){
                    ...
                    swal({
                        ...
                        .done(function(data){                   
                            ...
                            if(data.error == 0){
                                ...
                                $('#contTabla').html(data.tablaPreDiseno)
