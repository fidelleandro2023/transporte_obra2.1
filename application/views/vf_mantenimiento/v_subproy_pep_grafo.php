...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>public/bower_components/notify/pnotify.custom.min.css?v=<?php echo time();?>">
                    ...
                    <div class="card-block">
                        <div class="tab-container">
                            <ul class="nav nav-tabs nav-fill" role="tablist">                                 
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#messages-3" role="tab">PEP 2 - GRAFOS</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#messages-4" role="tab">SISEGO - PEP 2 - GRAFOS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#messages-5" role="tab">ITEMPLAN - PEP 2 - GRAFOS</a>
                                </li>
                               <?php if($this->session->userdata('idPersonaSession') == ID_USUARIO_OWEN_SARAVIA){?>
                                    <li class="nav-item">
                                         <a class="nav-link" data-toggle="tab" href="#settings-2" role="tab">REFRESH</a> 
                                    </li>
                                <?php }?>
                            </ul>
                                ...
                                <div class="tab-content">							
                                        ...
                                        <div class="tab-pane fade" id="messages-3" role="tabpanel">
                                            <div class="col-sm-6 col-md-4" style="TEXT-ALIGN: center;margin-top: 25px;    margin-left: auto;">
                                                        <div class="form-group">       
                                                            <button style="background-color: var(--verde_telefonica)" onclick="uploadPep2Grafo();" type="button" class="btn btn-success waves-effect">
                                                            <i class="zmdi zmdi-upload zmdi-hc-fw"></i>CARGAR GRAFOS</button>
                                                             <!-- nuevo Miguel Rios 06062018-->
                                                            <button style="background-color: var(--verde_telefonica)" onclick="deletePep2GrafoError();" type="button" class="btn btn-success waves-effect">
                                        ...
                                        <div class="tab-pane fade" id="messages-4" role="tabpanel">
                                            ...
                                            <!-- 
                                                <div class="form-group">       
                                                    <button style="background-color: var(--verde_telefonica)" onclick="uploadSisegoPep2Grafo();" type="button" class="btn btn-success waves-effect">
                                                    <i class="zmdi zmdi-upload zmdi-hc-fw"></i>CARGAR GRAFOS</button>
                                                </div>	
                                                -->		                         
                                            </div>
                                            <div id="contTablaSisegoGrafo" class="table-responsive">
                                                        <?php echo $tbSisegoPepGrafo?>
                                            </div>                                   
                                        </div>
                                        <div class="tab-pane fade" id="messages-5" role="tabpanel">
                                            <div class="col-sm-6 col-md-4" style="TEXT-ALIGN: center;margin-top: 25px;    margin-left: auto;">
                                                <div class="form-group">       
                                                    <button style="background-color: var(--verde_telefonica)" onclick="uploapItemPep2Grafo();" type="button" class="btn btn-success waves-effect">
                                                    <i class="zmdi zmdi-upload zmdi-hc-fw"></i>CARGAR COMBINATORIA</button>
                                                </div>
        			                         </div>
                                            <div id="contTablaItemGrafo" class="table-responsive">
                                                        <?php echo $tbItemPepGrafo?>
                                            </div>                                   
                                        </div>
                                        <div class="tab-pane fade" id="settings-2" role="tabpanel">
                                             <h1>REFRESH</h1><br>
            								 <h4>Opcion Deshabilitada. de requerir actualizar realice la carga de Sap en Tranferencia Sap Fija V2.<a style="color:blue" href="sapfiv2">Aqui</a></h4>
        								</div>
                                    </div>
                                </div>
                            </div>
