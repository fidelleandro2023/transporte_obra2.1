...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full section" style="display:none">
                <div class="content__inner">
                    <h2>MANTENIMIENTO PRECIARIO</h2>
                    <h4 id="textZonalEcc"></h4>
                    <div class="container">  
                        <div class="card">		 				                    
                            <div class="card-block"> 
                                ...
                                <div class="container"> 
                                    <div id="contTablaZonal" class="table-responsive form-group">
                                   
                                    </div>
                                    <div id="contTablaPreciario" class="table-responsive">
                                    </div>
                                </div>    
                            </div>
                        </div>
        ...
        <div class="modal fade" id="modalFiltroInicial" tabindex="-1">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Empresa Colaboradora</label>
                            <?php echo (isset($cmbEcc) ?  $cmbEcc : null )  ?>
                        </div>
                        <div class="form-group">
                            <label>Estaci&oacute;n</label>
                            <?php echo (isset($cmbEstacion) ?  $cmbEstacion : null )  ?>
                        </div>
                        <div class="form-group">
                            <label>Zonal</label>
                            <?php echo (isset($cmbZonal) ?  $cmbZonal : null )  ?>  
                        </div>
                        <div class="form-group">
                            <label>Tipo precio</label>
                            <?php echo (isset($cmbTipoCosto) ?  $cmbTipoCosto : null )  ?>  
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link" onclick="getPreciarioTb();">Aceptar</button>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-group container">
                            <label>Ingresar Costo</label>
                            <input id="inputCosto" class="form-control" />
                        </div>
                        <div id="cmbsIngresar" class="container">
                            <div id="contCmbEcc" class="form-group">
                            </div>
                            <div id="contCmbEstacion" class="form-group">
                            </div>
                            <div id="contCmbTipoCosto" class="form-group">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link" onclick="insertZonal();">Aceptar</button>
                        <button type="button" class="btn btn-link" data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_mantenimiento/jsPreciario.js?v=<?php echo time();?>"></script>
