...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>MANTENIMIENTO SUBPROYECTOS SIN DISE&Ntilde;O</h2>
                    <div class="container" align="center">  
                        <div class="card">		 				                    
                            <div class="card-block"> 
                                <div class="container"> 
                                    <div id="contTablaSubProyecto" style="display:none" class="table-responsive form-group">
                                            <?php echo (isset($tablaSubProyecto) ?  $tablaSubProyecto : null )  ?>
                                    </div>
                                    <div id="contTablaSinDiseno" class="table-responsive">
                                            <?php echo (isset($tablaSinDiseno) ?  $tablaSinDiseno : null )  ?>
                                    </div>
                                </div>    
                            </div>
                        </div>
        ...
        <div id="modalAlertaEliminar" class="modal fade" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success boton-acepto" onclick="deleteSubProyecto();">Aceptar</button>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_mantenimiento/jsBandejaSubSinDiseno.js?v=<?php echo time();?>"></script>
...
<script>
    ...
    function init() {
        ...
        $('#contTablaSubProyecto').css('display', 'block');
    }    
</script>