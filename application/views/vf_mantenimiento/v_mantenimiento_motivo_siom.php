...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>MANTENIMIENTO MOTIVO SIOM</h2>
                    <div class="card">		   				                    
                    
                        <div class="card-block">
                            <div>
                                <a onclick="openModalInsert()" style="background-color: (--verde_telefonica); color: white;" class="btn btn-primary" >AGREGAR MOTIVO</a>
                            </div>    
                            <div id="contTabla" class="table-responsive">
                                <?php echo !isset($tablaMotivoSiom) ? '' : $tablaMotivoSiom; ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="margin: auto;    font-weight: bold;" class="modal-title">REGISTRO MOTIVO</h4>
                            ...
                            <div class="modal-body">
                                <div class="col-sm-12 col-md-12">
									<div class="form-group">
                                        ...
                                        <input id="nomMotivo" name="motivo" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Tipo</label>
                                        <select id="cmbTipo" class="form-control select2" multiple>
                                            <option>Seleccionar</option>
                                            <option value="1">PEX</option>
                                            <option value="2">PIN</option>
                                            <option value="3">SIROPE</option>
                                        </select>
                                    </div>
                                </div>   
                            </div>
                            <div class="modal-footer">
								<button type="button" class="btn btn-success" onclick="registrarMotivo();">Aceptar</button>
                ...
                <div class="modal fade" id="modalEditar" >
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="margin: auto;    font-weight: bold;" class="modal-title">EDITAR MOTIVO</h4>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                            </div>
                            <div class="modal-body">
                                <div class="col-sm-12 col-md-12">
									<div class="form-group">
                                        <label>Nombre Motivo</label>
                                        <input id="nomMotivoEdit" name="motivo" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Tipo</label>
                                        <select id="cmbTipoEdit" class="form-control select2" multiple>
                                            <option>Seleccionar</option>
                                            <option value="1">PEX</option>
                                            <option value="2">PIN</option>
                                            <option value="3">SIROPE</option>
                                    ...
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select id="cmbStatusEdit" class="form-control select2">
                                            <option>Seleccionar</option>
                            ...
                            <div class="modal-footer">
								<button type="button" class="btn btn-success" onclick="actualizarMotivoSiom();">Aceptar</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                            </div>
                        </div>
                    </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_mantenimiento/jsMantenimientoMotivoSiom.js?v=<?php echo time();?>"></script>
    </body>
