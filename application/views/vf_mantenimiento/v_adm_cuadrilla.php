        ...
        <main class="main">
            ...
            <header class="header">
                ...
                <div class="header__logo hidden-sm-down" style="text-align: center;">
                   <a href="https://www.movistar.com.pe/" title="Entel Per&uacute;"><img src="<?php echo base_url();?>public/img/logo/logo-telefonica.jpg" alt="Logo Entel"></a>
                </div>
            ...
            <section class="content content--full" id="mCuadrilla">
                ...
                <div class="card container">
                   <div class="card-block table-responsive">      
                        <div class="form-group">
                            <input type="button" @click="openModalForm" class="btn-info" value="registrar">
                        </div>
                        <table id="data-table" class="table table-bordered ">
                            ...
                            <tbody>
                                <tr v-for="obj in arrayCuadrilla">
                                    <td>{{obj.idCuadrilla}}</td>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="button" class="btn btn-default boton-acepto" value="Aceptar" @click="registrarCuadrilla">
                            </div>
                        </div>
                    </div>
                </div>  
...
<script src="<?php echo base_url();?>public/bower_components/jquery/dist/jquery.min.js"></script>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_mantenimiento/adm_cuadrilla.js"></script>
