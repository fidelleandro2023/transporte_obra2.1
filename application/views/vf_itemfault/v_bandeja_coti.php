...
<html lang="en">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>BANDEJA DE COTIZACI&Oacute;N DE ITEMFAULT</h2>
                    <hr>
                    <div class="card">		   				                    
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title text-center">INGRESE PRESUPUESTO DE COTIZACI&Oacute;N</h1>
                    </div>
                    <br>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="6" id="inputMontoMO" class="form-control" type="text" placeholder="">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="6" id="inputMontoMAT" class="form-control" type="text" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="archivo_pdf" name="archivo_pdf" type="file" class="file" accept="application/pdf"
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itemfault/cotizado.js"></script>
