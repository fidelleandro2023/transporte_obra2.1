        ...
        <main class="main">
            ...
            <section class="content content--full">
                ...
                <div class="content__inner">
                    <h2>ITEMFAULT GESTIONAR OC: <?php echo $solicitud ?></h2>
        ...
        <script type="text/javascript">
                                        ...
                                        $('#preLoadFile').click(function (e) {
                                            ...
                                            if (listaFileValido != null && listaFileValido.length > 0) {
                                                ...
                                                swal({
                                                    title: 'Esta seguro de asignar la OC?',
                                                            ...
                                                            setTimeout(
                                                                    function ()
                                                                    {
                                                                        ...
                                                                        swal({
                                                                            ...
                                                                            window.location.href = "ItemFaultOC";
                                                                        });
...
//                                                            alert(data.msj);
//                                                            swal('warning', 'Error al insertar', data.msj);
//                                                            $('#modalProgreso').modal('toggle');
                                                        }
