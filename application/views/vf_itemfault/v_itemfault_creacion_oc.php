...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>ITEMFAULT CREACION DE OC</h2>
                    <div class="card">		   				                    
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="txtItemplan" type="text" class="form-control input-mask" placeholder="Itemfault" autocomplete="off" maxlength="16" style="border-bottom: 1px solid lightgrey">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_itemfault/jsItemfaultCreacionOC.js?v=<?php echo time();?>"></script>
