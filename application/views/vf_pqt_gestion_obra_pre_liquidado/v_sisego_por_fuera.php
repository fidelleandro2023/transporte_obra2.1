<button type="button" class="btn btn-primary" id="btnModalFormularioFuera" data-toggle="modal" data-target="#modalFormularioFuera" style="display: none;"></button>
<div id="modalFormularioFuera" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" tabindex="-1">
      ...
      <div class="modal-body">
        <div v-bind:class="{ 'tab-content' : (flg_from == 2) ? true : false}">
            ...
            <!-- <div v-if="flg_from == 2"> -->
                ...
                <div id="pruebasPerfil" class="tab-pane fade" >
...
<div id="modalUbicacion" class="modal fade" role="dialog" tabindex="-1">
