...
<body data-ma-theme="entel">
	...
	<section class="content--full">
			...
			<h2>Pre Liquidacion - Formulario SISEGO</h2>
			
        
<div id="modalFormularioFuera">
        ...
        <div class="modal-header">
            <div v-if="flg_from == 2">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a data-toggle="tab" href="#pruebasPerfil" @click="openTab(3)">Prueba / Perfil</a>
                </ul>
            </div>
        </div>
      <div class="modal-body">
        <div v-bind:class="{ 'tab-content' : (flg_from == 2) ? true : false}">
            <div id="formulario" v-bind:class="{ 'tab-pane in active' : (flg_from == 2) ? true : false }"> 
                <div class="form-group">
                        <label>&iquest;Con licencia?</label>
                        <select v-model="licenciaAfirm" >
                    ...
                    <div class="form-group">
                        ...
                        <select id="cmbTipoObra" v-model="cmbTipoObra"  v-on:change="getComboCodigo">
                    ...
                    <div v-if="cmbTipoObra == 1">
                        <div class="row form-group">
                            ...
                            <input type="text"  v-model="nombreCtoNap">
                            </div>
                            <div class="col-sm-3 form-group">
                            <label># Troncal</label>
                            <input type="text"  v-model="nroTroncal">
                            </div>
                            <div class="col-sm-3 form-group">
                                <label>Cant. hilos hab.</label>
                                <input type="number"  v-model="cantidadHilosNap">
                                </div>
                                <div class="col-sm-3 form-group">
                                <label>Nodo</label>
                                <input type="text"  v-model="nodo">
                            </div>
                             <div class="col-sm-3 form-group">
                                <label>Coordenada X</label>
                                <input id="coor_x" type="text" >
                            </div>
                            <div class="col-sm-3 form-group">
                                <label>Coordenada Y</label>
                                <input id="coor_y" type="text" >
                                <button class="btn-info" @click="openModalGeo">Abrir geolocalizacion</button>
                            </div>   
                            <div class="col-sm-3 form-group">
                                <label>Ubicaci&oacute;n</label>
                                <select id="cmbUbicacion"  v-model="selectedUbica">
                                    <option value="0">Seleccionar</option>     
                        ...
                        <div v-if="cmbTipoObra == 2">
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" v-model="foOscuCantHilos">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Cantidad de Nodos</label>
                                    <input type="text" v-model="foOscuCantNodo">
                                </div>
                                    ...
                                    <div class="form-group" v-if="foOscuCantNodo > 0 " v-for="n in parseInt(foOscuCantNodo)">
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <!-- <input class="form-control" v-bind:id="'input_'+n"> -->
                                                <select   v-bind:id="'cmb_'+n" v-on:change="getCodigoObraArray(parseInt(n))">
                                                    <option value="0">Seleccionar</option>
            ...
            <!-- <div v-if="flg_from == 2"> -->
                <div id="material" class="tab-pane " style="display:none">
                    <div v-for="row in arrayFichaTecnica">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <input v-bind:id="'inputCantidadTrabajo'+row.id_ficha_tecnica_trabajo" type="text" value="0" >
                            </div>
                            <div class="form-group col-md-3">
                                <select   v-bind:id="'selectTrabajo'+row.id_ficha_tecnica_trabajo">
                                    <option value="">Seleccionar</option>
                                    <option v-for="option in arrayCmbTipoFicha" v-bind:value="option.id_ficha_tecnica_tipo_trabajo">{{option.descripcion}}</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                                <textarea v-bind:id="'inputComentarioTrabajo'+row.id_ficha_tecnica_trabajo" ></textarea>
                            </div>
                        </div>    
                    </div>
                    <div>
                ...
                <!-- NUEVO DE PERFIL Y PRUEBAS PDF -->
                <div id="pruebasPerfil" class="tab-pane " >
                    <div id="buttonFotosFuera" class="form-group"></div>
                    <div>
                        <h5>Pruebas Reflectométricas(PDF)</h5>
                        <div id="dropzone15" class="dropzone" >
                    ...
                    <div>
                        <h5>Perfil(PDF)</h5>
                        <div id="dropzone16" class="dropzone" >
...
<button type="button" class="btn btn-primary" id="btnModalUbicacion" data-toggle="modal" data-target="#modalUbicacion" style="display: none;"></button>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA3a1icJt1Zeq9YFBtwp1rZKb2biTJeE4I&callback=init" async defer></script>
	...
	$(function() {
		...
		var vue = this;
		var jefatura   = <?php echo '"'.$jefatura.'"' ?>;
		var itemPlan   = <?php echo '"'.$itemPlan.'"' ?>;
		var flg_from   = <?php echo '"'.$flg_from.'"' ?>;
		
		if(flg_from == 2) {
		    var idEstadoPlan     = <?php echo '"'.$id_estado_plan.'"' ?>;
		    var idEstacion       = <?php echo '"'.$id_estacion.'"' ?>;
		    var indicador        = <?php echo '"'.$indicador.'"' ?>;
		    var descEmpresaColab = <?php echo '"'.$desc_emp_colab.'"' ?>;
