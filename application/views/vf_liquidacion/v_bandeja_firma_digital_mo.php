...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
                        ...
                        <div class="card-block"> 
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label>EECC</label>
                                        <select id="cmbEmpresaColab" name="selectEECC" class="select2" onchange="filtrarTablaFirmaDigital()">
                                            <option value="">&nbsp;</option>
                                                <?php
                                ...
                                <div class="col-sm-12 col-md-6">    
                                    <div class="form-group">
                                        ...
                                        <select id="cmbJefatura" name="selectEECC" class="select2" onchange="filtrarTablaFirmaDigital()">
                                            <option value="">&nbsp;</option>
                                                <?php
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="fechaInicio" type="date" class="form-control" onchange="filtrarTablaFirmaDigital();"/>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">    
                                    <div class="form-group">
                                        <label>FECHA FIN</label>
                                        <input id="fechaFin" type="date" class="form-control" onchange="filtrarTablaFirmaDigital();" />
                                    </div>
                                </div>
                            </div>
                            <div id="contenido">
                                <div id="contTablaFirmaDigital" class="table-responsive form-group" >
                                    <?= isset($tablaFirmaDigital) ? $tablaFirmaDigital : NULL; ?>
                                </div>
                                <div>
                                    <button class="btn btn-success" onclick="openModalValidarFirmaDigital();">Aceptar</button>                        
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalAlertaValidacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                ...
                <div class="modal-body">
                    <a>Al aceptar, se validar&aacute;.</a>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" onclick="validarFirmaDigital();">Aceptar</button>
                </div>
                </div>
            </div>
        </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_liquidacion/jsBandejaFirmaDigitalMo.js?v=<?php echo time();?>"></script>
