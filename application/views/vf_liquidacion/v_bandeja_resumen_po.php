...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-4">
                                        <div class="form-group">
                                            <label>EECC</label>
                                            <select id="cmbEmpresaColab" name="selectEECC" class="select2" onchange="filtrarTablaResumen()">
                                                <option>&nbsp;</option>
                                                    <?php
                                     ...
                                     <div class="col-sm-12 col-md-4">    
                                        <div class="form-group">
                                            ...
                                            <select id="cmbJefatura" name="selectEECC" class="select2" onchange="filtrarTablaResumen()">
                                                <option>&nbsp;</option>
                                                    <?php
                                    ...
                                    <div id="contTablaResumenPo" class="table-responsive">
                                        <?php echo $tablaResumenPO?>
                                    </div>
                                </div>
                            </div>
                        </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_liquidacion/jsBandejaResumenPo.js?v=<?php echo time();?>"></script>
    </body>
