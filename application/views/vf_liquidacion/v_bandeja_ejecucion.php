...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
		                   ...
		                   <div class="content__inner">
                                    <h2 style="color: #333333d4;font-weight: 800;text-align: center;">BANDEJA DE EJECUCION</h2>
		   				                    <div class="card">
                    ...
                    <form id="formAdjudicaItem" method="post" class="form-horizontal">                       
                           ...
                           <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="selectSubAdju" name="selectSubAdju" class="select2">
                                        <option>&nbsp;</option>
                                        <?php                                                    
                                                    foreach($listaSubProy->result() as $row){                      
                                                ?> 
                                 ...
                                 <div class="col-sm-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                        <label>MDF</label>
                                        <input id="inputMDF" name="inputMDF" type="text" class="form-control input-mask">
                                        <i class="form-group__bar"></i>
                                         </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="selectZonificacion" name="selectZonificacion" class="select2 form-control" onchange="revalidate()">
                                            <option value="1">BUCLE</option>                                       
                                            <option value="2">CV (CRECIMIENTO VERTICAL)</option>                                              
                                        </select>
                                    </div>
                                </div>
                               <div class="col-sm-6 col-md-6" id="divEECC" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <select id="selectEECCDiseno" name="selectEECCDiseno" class="select2 form-control">
                                            <option>&nbsp;</option>                                       
                                                ...
                                                ?>
                                             <option value="<?php echo utf8_decode($row->id) ?>"><?php echo utf8_decode($row->empresacolabDesc) ?></option>
                                             <?php }?>
                                             
                                        </select>
                                    </div>
                                </div>
                               	<div class="col-sm-6 col-md-6"  id="contFecEjec">
                                        <label>Fecha Inicio</label>    
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                            <div class="form-group">
                                                <input id="inputFecInicio" name="inputFecInicio" type="text" class="form-control date-picker" placeholder="Pick a date">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                	</div>
                                	<div class="col-sm-6 col-md-6"  id="contFecTerm">
                                        <label>Fecha Prev. Ejecucion</label>    
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                            <div class="form-group">
                                                <input id="inputFecPrevEjec" name="inputFecPrevEjec" type="text" class="form-control date-picker" placeholder="Pick a date">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                	</div>
   ...
   <!--  tables -->
    	    ...
    	    fields: {
    	    	selectSubAdju: {
      	    	  ...
      	    	  inputMDF: {
        	            validators: {
        	                notEmpty: {
        	                    message: '<p style="color:red">(*) Debe ingresa MDF</p>'
        	                }
        	             }
         	    	   },
          	    	  selectZonificacion: {
        	            validators: {
        	                notEmpty: {
        	                    message: '<p style="color:red">(*) Debe seleccionar una Zonificacion.</p>'
        	                }
        	             }
         	    	   },
          	    	  selectEECCDiseno: {
        	            ...
        	            validators: {
        	                notEmpty: {
        	                    message: '<p style="color:red">(*) Debe ingresar una fecha prevista de ejecucion.</p>'
        	                }
        	             }
         	    	   },
          	    	  inputFecInicio: {
        	            validators: {
        	                notEmpty: {
        	                    message: '<p style="color:red">(*) Debe ingresar una fecha de inicio.</p>'
        	                }
        	             }
         	    	   }
        ...
        function aprobarDiseno(component){
        	...
        	swal({
                title: 'Esta seguro de Ejecutar el Diseño?',
                text: 'Asegurese de validar la informacipón seleccionada!',
                type: 'warning',
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonClass: 'btn btn-primary',
                confirmButtonText: 'Si, Ejecutar el Diseño!',
