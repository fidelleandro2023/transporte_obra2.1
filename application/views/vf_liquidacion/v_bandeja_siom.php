...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="cmbNoEnviado" class="form-control select2">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <button style="margin-top: 30px;" class="btn btn-success waves-effect" type="button" onclick="filtrarTablaSiom();">CONSULTAR</button>
                                </div>
                            </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_liquidacion/jsBandejaSiom.js?v=<?php echo time();?>"></script>
