...
<!-- Small -->
        ...
        <div class="modal fade" id="modalAlertCancelPO" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                ...
                <div class="modal-body">
                    <a>Al aceptar, se cancelar&aacute; el PO.</a>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-success" onclick="cancelarPO()">Aceptar</button>
                </div>
                </div>
            </div>
        </div>
   ...
   <!--  tables -->
        ...
        <script type="text/javascript">
            ...
            function openModalAlertCancelPO(component){

                itemplanGlob = $(component).data('itemplan');
                codigoPOGlob = $(component).data('codigopo');
                idEstacionGlob = $(component).data('estacion');

                modal('modalAlertCancelPO');
            }
            

            function cancelarPO(){

                if(itemplanGlob != null && codigoPOGlob != null && idEstacionGlob != null) {
                    $.ajax({
                        type: 'POST',
                        url: 'cancelarPO',
                        data: {
                        ...
                        if (data.error == 0){console.log("ENTROOOOOOO.........");
                            //$('#contTabla').html(data.tablaConsulta);
                    ...
                    mostrarNotificacion('error', 'Error', 'No selecciono correctamente la PO!!');
                }
