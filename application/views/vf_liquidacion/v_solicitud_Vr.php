...
<html lang="en">
                            ...
                            <div class="card-block">
                                <div class="table-responsive">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3" id="subirExcel" style="display:none">      
                                            <button class="btn-info" onclick="openModalBloc()">bloc Notas</button>                          
                                            <div id="dropzone1" class="dropzone" >
                                            </div>
                                            <hr style="border:1;">
                                            <div>
                                                <a href="uploads/vale_reserva_solicitud/formato_VR.xlsx"><i class="zmdi zmdi-hc-2x zmdi-download"></i> DESCARGAR FORMATO EXCEL</a>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="card" id="cardKit" style="display:none">
                                            <h5 class="card-header h5">Materiales</h5>
                                            <div class="card-body">
                                                <h5 class="card-title">Para la obra</h5>
                                                <h5 class="card-title" id="totalMat"></h5>
                                                <div id="contTablaKit" class="container">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="<?php echo base_url();?>public/js/solicitud_Vr.js?v=<?php echo time();?>"></script>
    
<script>
    $(document).ready(function(){
        $('.dz-message').html('<span>Subir archivo SAP </span>')
    });
