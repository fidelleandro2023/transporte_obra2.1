        ...
        <main class="main">
            ...
            <section class="content content--full">
		                   ...
		                   <div class="content__inner">
                                    <h2>BANDEJA CERTIFICACION MO</h2>
		   				                    <div class="card">
		   				                        ...
		   				                        <div class="card-block">	   				                         
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="selectEECC" name="selectEECC" class="select2">
                                                                     <option>&nbsp;</option>
                                                                            ...
                                                                            <option value="CALATEL">CALATEL</option>
                                                                       <option value="LARI">LARI</option>
                                                                        <option value="DOMINIONPERU SOLUCIONES Y SERVICIOS S.A.C.">DOMINIONPERU SOLUCIONES Y SERVICIOS S.A.C.</option>
                                                        ...
                                                        <div class="col-sm-3 col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="fechaValidacion"><input type="date" name="fechaValidacion" id="fechaValidacion"></label>
                                                     ...
                                                     <div class="row">
                                                         <div class="col-sm-12 col-md-12">
                                                            <a class="btn" style="background-color: #28B463; color: white; padding: 10px" href="excelCMO">Descargar Detalle</a>
                                                        </div>
                                                     </div>
...
/*
        ...
        */
        function saveHojaGestion(component){
            var hoja_gestion =  $('#inputHojaGestion').val();
            if(hoja_gestion!=''){
        ...
        function filtrarTabla(){   	 
     	  var eecc = $.trim($('#selectEECC').val());        	
          var fechaValidacion = $.trim($('#fechaValidacion').val());
