...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
                    ...
                    <div class="container" align="center">  
                        <div class="card col-md-10">		 				                    
                            <div class="card-block"> 
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="cmbSubProyectoFiltro" name="" class="select2 text-left" onchange="filtrarTablaSwitchSiom()">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="cmbEccFiltro" name="selectEECC" class="select2" onchange="filtrarTablaSwitchSiom()">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="cmbJefaturaFiltro" class="form-control select2" onchange="filtrarTablaSwitchSiom();">
                                ...
                                <div>
                                    <div class="text-left">
                                        <button class="btn btn-success" onclick="openModalRegistro();">Registrar</button>                        
                                    </div> 
                                </div> 
        ...
        <div class="modal fade" id="modalEditarSwitch" tabindex="-1">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>SubProyecto</label>
                            <select id="contSubProyecto" class="form-control">
                            </select>
                            <span id="validaSubProyecto"></span>
                        </div>
                        <div class="form-group">
                            <label>Empresa Colaboradora</label>
                            <select id="contCmbEcc" class="form-control">
                            </select>
                            <div id="validaEmpresaColab"></div>
                        </div>
                        

                        <div class="form-group">
                            <label>Jefatura</label>
                            <select id="contJefatura" class="form-control">
                            </select>
                            <span id="validaJefatura"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span id="validaFecha"></span>   
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button id="btnModalReAc" type="button" onclick="" class="btn btn-link">Aceptar</button>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_liquidacion/jsSwitchSiom.js?v=<?php echo time();?>"></script>
