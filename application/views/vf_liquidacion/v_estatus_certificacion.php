		   				                        ...
		   				                        <div class="row">
                                                        <div class="col-sm-12 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="selectEECC" <?php echo (($eecc!='') ? 'disabled' : ' onchange="filtrarTabla()" ')?> name="selectEECC" class="select2" >
                                                                     <?php if($eecc=='') { ?>
                                                                         <option>&nbsp;</option>                                                                     
                                                                    ...
                                                                    <?php } else{   ?>
                                                                        <option  value="<?php echo $eecc?>"><?php echo $eecc?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
