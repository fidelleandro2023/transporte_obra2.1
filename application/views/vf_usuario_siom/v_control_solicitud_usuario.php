...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>CONTROL SOLICITUD USUARIO</h2>
                    <div class="card">		   				                    
				...
				<div class="modal fade" id="modalUsuarioActivo"  tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="margin: auto;    font-weight: bold;" class="modal-title">USUARIOS ACTIVOS</h4>
                            ...
                            <div class="modal-body">
                                <!-- <div class="col-sm-12 col-md-12"> -->
									<div id="contTablaUsuarioAct" class="table-responsive">
                                    </div>
                                <!-- </div>    -->
                            </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_usuario_siom/js_control_solicitud_usuario.js?v=<?php echo time();?>"></script>
    </body>
