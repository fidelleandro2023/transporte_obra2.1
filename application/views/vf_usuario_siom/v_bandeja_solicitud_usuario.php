...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>BANDEJA SOLICITUD USUARIO</h2>
                    <div class="card">		   				                    
                        ...
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <buttom class="btn btn-success" onclick="filtrarTablaSolicitudUsuario();">Consultar</buttom>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="modalUsuario"  tabindex="-1">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="margin: auto;    font-weight: bold;" class="modal-title">INGRESAR USUARIO</h4>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                            </div>
                            <div class="modal-body">
                                <div class="col-sm-12 col-md-12">
									<div class="form-group has-feedback" style="">
											<label>USUARIO</label>
											<input id="inputUsuario" name="inputUsuario" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
											<div id="msjValidUsuario"></div>
										</div>
									</div>   
									<div class="col-sm-12 col-md-12">
										<div class="form-group has-feedback" style="">
											<label>CLAVE</label>
											<input id="inputClave" name="inputClave" type="password" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
											<div id="msjValidClave"></div>
										</div>
									</div> 
									<div class="col-sm-12 col-md-12">
										<div class="form-group has-feedback" style="">
											<label>CLAVE</label>
											<input id="inputClave2" name="inputClave2" type="password" placeholder="Ingresar nuevamente la clave" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
											<div id="msjValidClave2"></div>
										</div>
									</div> 
								</div>
                            <div class="modal-footer">
								<button type="button" class="btn btn-success" onclick="ingresarUsuario();">Aceptar</button>
				...
				<div class="modal fade" id="modalRechazo"  tabindex="-1">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="margin: auto;    font-weight: bold;" class="modal-title">RECHAZO</h4>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                            </div>
                            <div class="modal-body">
                                <div class="col-sm-12 col-md-12">
									<div class="form-group" style="">
											...
											<textarea id="observacionRechazo" class="form-control">
											</textarea>
										</div>
									</div>   
								</div>
                            <div class="modal-footer">
								<button type="button" class="btn btn-success" onclick="rechazarSolicitud();">Aceptar</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                            </div>
                        </div>
                    </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_usuario_siom/js_bandeja_solicitud_usuario.js?v=<?php echo time();?>"></script>
    </body>
