...
<html lang="en">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>BANDEJA DE VALIDACI&Oacute;N DE ITEMPLAN MADRE</h2>
                    <hr>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itempla_madre/js_bandeja_validacion.js?v=<?php echo time(); ?>"></script> 
    </body>
