...
<html lang="en">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>BANDEJA DE REGISTRO DE ITEMPLAN MADRE</h2>
                    <hr>
                        ...
                        <div class="card-block"> 
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <a class="btn btn-success waves-effect" href="getItemplanMadre" target="_blank">Nuevo Itemplan Madre</a>
                                    </div> 
                                </div>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itempla_madre/js_bandeja_registro.js?v=<?php echo time(); ?>"></script> 
    </body>
