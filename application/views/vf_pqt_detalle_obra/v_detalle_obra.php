        ...
        <section class="content content--full">
            <div class="content__inner">
                <h2 class="text-center">DETALLE ITEMPLAN: <strong id="itemTitle"><?php echo $item?></strong></h2>
                    ...
                    ?>
                <br>
                <h5 class="text-center" style="color:red">Para el registro de PO de material debe hacer click en el area correspondiente. Ejm:"MAT_FO".<strong></strong></h5>
                <br>				
...
<?	if($poMoPaquetizado > 0 && $idProyecto <> ID_PROYECTO_TRANSPORTE &&  $idProyecto <> ID_PROYECTO_OBRA_PUBLICA){					
				?>
				<br>
                <h5 class="text-center" style="color:red">Obra Paquetizada, no requiere de registro de PO de tipo MO en las estaciones COAXIAL Y FO.<strong></strong></h5>
                <br>
				<? }
				?>
                            ...
                            <div class="tab-pane fade" id="presupuesto" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-12">
										...
										<h4>Info. trama robot</h4>
										<div>
											<div id="contablaLogSap" class="table-responsive"></div>
										</div>
                                    </div>
                                </div>
                            </div>
	...
	<div class="modal fade" id="modal-parti-adic" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title pull-left">Informaci&oacute;n</h5>
    ...
    <script type="text/javascript">
        ...
        function getPtr(component) {
            ...
            itemplanGlob = $(component).attr('data-itemplan');
            idEstacionGlob = $(component).attr('data-estacion');
            idSubProyectoGlob = $(component).attr('data-idsubproy');
            ...
            $.ajax({
                ...
                if (data.error == 0) {
					...
					$('#contablaLogSap').html(data.tablaLogRpaSapAprob);
        ...
        function openModalMotivoPreCancelacion() {
            if (poGlob != null && itemplanGlob != null && idEstacionGlob != null && idSubProyEstaGlob != null) {
                $.ajax({
                    type: 'POST',
        ...
        function preCancelarPO() {
            ...
            if (itemplanGlob != null && poGlob != null && idEstacionGlob != null) {
                ...
                swal({
                    title: 'Est&aacute; seguro de Pre cancelar el PO?',
                    text : 'Para cancelar la PO, asegurarse de que los materiales tomados hayan sido devueltos, recuerde que esta PO pasara a la bandeja de cancelacion!',
                    type: 'warning',
        ...
        //asdasdasd
		  ...
		  function cargarPartidasAdic(itemplan, idEstacion, codigo_po){
            //$("#divModuloLoad").load("poMoAdic?itm="+itemplan+"&idEs="+idEstacion);
        	modal('modal-info');
        	$("#divModuloLoad").load("poMoAdicPqt?itm="+itemplan+"&idEs="+idEstacion+"&po="+codigo_po);
        	modal('modal-parti-adic');
        }

        function cargarRegMateriales(itemplan, idEstacion, codigo_po){
            //$("#divModuloLoad").load("regMatEsta?ite="+itemplan+"&est="+idEstacion);
        	modal('modal-info');
        	$("#divModuloLoad").load("regMatEstaPqt?ite="+itemplan+"&est="+idEstacion+"&po="+codigo_po);
        	modal('modal-parti-adic');    
        }
