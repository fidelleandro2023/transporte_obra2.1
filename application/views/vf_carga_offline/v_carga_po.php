...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>CARGA DE MO Y MAT</h2>
                    <div class="card">
                        <div class="card-block">	   				                         
                            <div class="row">
                                <section>
                                    <label style="font-size: smaller;text-align: left;">- La carga actualizar&aacute; el excel en el extractor de MAT y MO (offline).</label><br>
                                    ...
                                    <label style="font-weight: bold;color: red;font-size: smaller;text-align: left;">- Si no llega al 100%, comunicarse con el programador a cargo.</label><br>
                                    <div id="contProgres">
        ...
        <script src="<?php echo base_url();?>public/js/js_carga_offline/jsCargaPo.js?v=<?php echo time();?>"></script>  
