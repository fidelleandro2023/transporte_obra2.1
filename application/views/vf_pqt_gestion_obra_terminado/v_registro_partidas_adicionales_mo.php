                ...
                <div class="form-group col-sm-12" style="text-align: center;">		<!--		
				 ...
				 <div class="row">
                    <div class="form-group col-md-3" style="text-align: center;">                        
                        <input type="button" data-itm="<?php echo $itemplan?>" data-esta="<?php echo $idEstacion?>" id="btnExportFormato" value="1) Exportar Partidas" class="btn-success" onclick="exportPartidas(this)">
                    </div>
                    ...
                    <div class="form-group col-md-4" style="text-align: center;">                        
                        <input type="button" data-itm="<?php echo $itemplan?>" data-esta="<?php echo $idEstacion?>" id="preLoadFile" value="3) Generar Partidas" class="btn-success">
                    </div>      
                </div>
   ...
   <!--  tables -->
        ...
        $('#preLoadFile').click(function(e){
            if(listaFileValido!=null && listaFileValido.length>0){
            	...
            	var montoTotalMo = monto_final_po;
          //  	canCreateEditPOByCostoUnitario('2','1',null, itemplan, montoTotalMo, function() {
                    	swal({
                            title: 'Está seguro Adicionar las Partidas?',
