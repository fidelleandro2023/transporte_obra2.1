 ...
 <?php include 'application/views/v_opciones.php';?>
            ...
            <section class="content content--full">
		                   <div class="content__inner">
                               <h2>REPORTE CRECIMIENTO VERTICAL</h2>
                               <hr>
                               ...
                               <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="selectSubProy" name="selectSubProy" class="select2" multiple>
                                                        <option>&nbsp;</option>
                                                        <?php foreach($listaSubProy as $row){ ?> 
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="selectJefatura" name="selectJefatura" class="select2" multiple>
                                                        <option>&nbsp;</option>
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="selectEECC" name="selectEECC" class="select2" multiple>
                                                        <option>&nbsp;</option>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="tab-pane active fade show" id="reporte" role="tabpanel">
                                                <div id="contTablaReporte" class="table-responsive">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 id="tituloModal" style="margin: auto;font-weight: bold;" class="modal-title">DETALLE DE OBRAS</h4>
   ...
   <!--  tables -->
        ...
        <script type="text/javascript">
            ...
            function filtrarTabla(){
                ...
                var idSubProyecto = $.trim($('#selectSubProy').val()); 
                ...
                .done(function(data){
                    ...
                    if(data.error == 0){
                        $('#contTablaReporte').html(data.tablaReporte);
