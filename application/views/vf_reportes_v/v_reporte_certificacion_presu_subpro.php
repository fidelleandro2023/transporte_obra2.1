 ...
 <?php include 'application/views/v_opciones.php';?>
            ...
            <section class="content content--full">
		                   <div class="content__inner">
                               <h2>REPORTE CERTIFICACION - PRESUPUESTO - SUBPROYECTO</h2>
                               <hr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="selectProy" name="selectProy" class="select2">
                                                        ...
                                                        <?php foreach($listaSubProy->result() as $row){ ?> 
                                                            <option value="<?php echo trim($row->subProyectoDesc) ?>"><?php echo $row->subProyectoDesc ?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
