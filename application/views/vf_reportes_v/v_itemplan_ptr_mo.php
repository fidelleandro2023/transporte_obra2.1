...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <body data-ma-theme="entel">
      ...
      <tr height="5px">
         <td style="background-color:#FF0000" width="16.66%"></td>
         <td style="background-color:#1CDDC5" width="16.66%"></td>
         <td style="background-color:#78E900" width="16.66%"></td>
         <td style="background-color:#767680" width="16.66%"></td>
         <td style="background-color:#F7FA07" width="16.66%"></td>
         <td style="background-color:#FFFFFF" width="16.66%"></td>
      </tr>
    </tbody></table>
