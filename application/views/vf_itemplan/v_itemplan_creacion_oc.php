...
<html lang="en">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>Bandeja orden de compra OPEX</h2>
                    <div class="card">		   				                    
     ...
     <div class="modal fade" id="modalCertificarHG"  tabindex="-1">
        ...
        <div class="modal fade" id="modaPxq"  tabindex="-1">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 style="margin: auto" id="tittleCertificarHG" class="modal-title"></h3>
                    ...
                    <div class="modal-body">               
                        <div id="contTablaPxq" class="table-responsive">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    ...
                    <div class="modal-body">
                        <form id="formReenviarTrama" method="post" class="form-horizontal">
                            <div class="form-group form-group--float col-sm-12">
                                ...
                                <label style="font-weight: bold;;left: auto;">MDF ACTUAL</label>
                                <i class="form-group__bar"></i>
                            </div>
                            <div class="form-group col-sm-12">
                                <label style="font-weight: bold;">MDF DE REENVIO</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formReenviarTrama2" method="post" class="form-horizontal">                            
                            <div class="form-group col-sm-12">
                                <label style="font-weight: bold;">ESTACION</label>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itemplan/jsItemplanCreacionOC.js?v=<?php echo time(); ?>"></script>
