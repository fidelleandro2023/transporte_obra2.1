...
<html lang="en">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>CONFIGURACI&Oacute;N DE CUENTA OPEX</h2>
                    <hr>
                    <div class="card">	   				                    
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <button class="btn btn-success waves-effect" onclick="consultaCuentaOpex()">CONSULTAR</button>
                                    </div> 
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <button class="btn btn-success waves-effect" onclick="agregarCuentaOpex()">NUEVA CONFIGURACI&Oacute;N</button>
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input  id="inputMontoFinalorigin"  type="hidden" >
                                    <input  id="inputMontoTemporalorigin"  type="hidden" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="selectAnhoAdd" name="selectEventoAdd[]" class="select2" required>
                                        ...
                                        foreach ($fases as $row) {
                                            ?> 
                                            <option value="<?php echo $row->faseDesc ?>"><?php echo $row->faseDesc ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modal_form_log"  tabindex="-1">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 style="margin: auto" id="tittleCertificarHG" class="modal-title">LOG</h3>
                    </div>
                    <div class="modal-body">
                        <div id="contTablaLog" style="display:block" class="table-responsive form-group col-md-12">
                            <?php echo isset($tablaLog) ? $tablaLog : null ?>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        ...
        <script src="<?php echo base_url(); ?>public/js/js_itemplan/configOpex.js?v=<?php echo time(); ?>"></script>
