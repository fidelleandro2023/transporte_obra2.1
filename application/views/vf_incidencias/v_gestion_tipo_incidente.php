    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                           ...
                           <h2>GESTION DE TIPO DE OBSERVACIONES</h2>
                           <hr>
		                    <div class="card">
		                        <div class="card-block">
		                          <div class="row">
                                    <button class="btn btn-success waves-effect" type="button" onclick="openModalNuevoIncidente()">REGISTRAR NUEVO TIPO DE OBSERVACION</button>
                                  </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="margin: auto;">
                <h5 style="font-weight: bold;" class="modal-title pull-left">NUEVO TIPO DE OBSERVACION</h5>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>ID TIPO OBSERVACION</label>
                                <input type="number" id="txtTipoIncidente" name="txtTipoIncidente" class="form-control" onchange="validarid()"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
 ...
 <script src="<?php echo base_url();?>public/bower_components/flatpickr/dist/flatpickr.min.js"></script>
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
      	function openModalNuevoIncidente(){
          	$("#txtTipoIncidente").prop('disabled', false);
      		$("#selectEstado").val("").trigger('change');
      		$('#txtTipoIncidente').val('');
      		$('#txtDescripcion').val('');
      		$('#txtComentario').val('');
        ...
        .bootstrapValidator({
                ...
                fields: {
                	txtTipoIncidente: {
                        validators: {
                            notEmpty: {
                                message: '<p style="color:red">(*) Debe escribir un id de tipo de observacion.</p>'
                            }
                        }
                    },
                    txtDescripcion: {
            ...
            if(hTipoActividad == 'ACTUALIZAR'){
            	formData.append('txtTipoIncidente', $('#txtTipoIncidente').val());
            }
            formData.append('hTipoActividad', hTipoActividad);
    
            $.ajax({
                data: formData,
                url: "pqt_registrar_tipo_incidente",
                cache: false,
                contentType: false,
                processData: false,
                type: 'POST'
            ...
            .done(function (data) {
                ...
                if (data.error == 0) {
                    ...
                    swal({
                             ...
                             text: 'Codigo de Observacion: ' + data.codigo_tipo_incidente,
                             type: 'success',
        ...
        function abrirModalInfo(component){
        	...
        	var id_tipo_incidente = $(component).data('id_tipo_incidente');
        	...
        	$("#txtTipoIncidente").prop('disabled', true);
        	$("#selectEstado").val(estado).trigger('change');
      		$('#txtTipoIncidente').val(id_tipo_incidente);
        ...
        function validarid(){
        	var txtTipoIncidente = $("#txtTipoIncidente").val();
        	var formData = new FormData();
            formData.append('txtTipoIncidente', txtTipoIncidente);
        	
        	$.ajax({
                data: formData,
                url: "pqt_validar_id_tipo_incidente",
                cache: false,
                contentType: false,
                processData: false,
                type: 'POST'
