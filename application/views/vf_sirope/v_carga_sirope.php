...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                ...
                <div class="form-group col-sm-12" style="text-align: center;">		<!--		
					...
					<label style="color: red" class="control-label mb-10 text-left">Debera ajustar todas las columnas al tamaño del texto de todo el contenido del archivo  .xlsx</label><br>
				 ...
				 <div class="row">
                   ...
                   <div id="contSubirInfo" class="col-sm-12 col-md-9" style="text-align: right;display: none">
				        <a href="makeSiEx" type="submit" class="btn btn-danger btn-anim">NO ENCONTRADOS</a>
                	...
                	<table style="font-size: 10px" id="data-table2" class="table table-bordered">
                    	<thead class="thead-default">                        
                           <tr role="row">
                                ...
                                <th colspan="1">CARACTERISTICA</th>                          
                                <th colspan="1">ESTADO ACTUAL</th>          
   ...
   <!--  tables -->
        ...
        $('#preLoadFile').click(function(e){console.log("ENTRO FILE");
            if(listaFileValido!=null && listaFileValido.length>0){
            	...
            	console.log('enviando....');
         	    $.ajax({
         	    	type	:	'POST',
         	    	'url'	:	'saveDataSI',
         	    	data	:	JSON.stringify(jsonDataFile),
