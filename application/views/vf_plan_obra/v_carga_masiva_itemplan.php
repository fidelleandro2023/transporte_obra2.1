...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>GENERACI&Oacute;N MASIVA DE PO</h2>
                    <div class="card">
                        <div class="card-block">	   				                         
                            <div class="row">
                                <section>
                                    ...
                                    <label style="font-size: smaller;text-align: left;">- Puede descargar un ejemplo de la estructura.</label><a href="download/modelos/ejemplo_generar_po.xlsx" >Aqu&iacute;</a><br>
                                    <label style="font-weight: bold;color: red;font-size: smaller;text-align: left;">- Si se genera alg&uacute;n error estar&aacute; con la fila en rojo y su motivo.</label><br>
                                    <label style="font-weight: bold;color: red;font-size: smaller;text-align: left;">- Si se genera alguna alerta estar&aacute; con la fila de un color distinto al rojo.</label><br>
                                    <label style="font-weight: bold;color: red;font-size: smaller;text-align: left;">- Cuando se suba el archivo, solo se mostrar&aacute;n los itemplan de estado dise&ntilde;o.</label>
                                    <div id="contProgres">
        ...
        <script src="<?php echo base_url();?>public/js/js_planobra/jsCargaMasivaItemplan.js?v=<?php echo time();?>"></script>  
