                        ...
                        <div class="card-block">	   				                         
                                <div class="row">
                                    ...
                                    <section>
                                     ...
                                     <label style="font-size: smaller;text-align: left;">- El archivo tiene un formato de 2 columnas separados por Tabulaciones.</label><br>
                                     <label style="font-size: 14px;text-align: left; color: red"> El campo "FECHA" debe estar en el formato DD/MM/YYYY ejemplo: 01/12/2018.</label><br>
                                      <label style="font-size: 14px;text-align: left; color: red"> IMPORTANTE NO COLOCAR CAMPOS 00/00/0000 O VACIO</label><br>
                                     <label><a href="uploads/dp/modelo/modeloLiquidador.txt" download="modeloLiquidador.txt">Descargar formato .txt</a></label>
                                    <br><br>
                                     <div id="contProgres">
