                                        ...
                                        <div class="row" id="infocontenido" style="text-align: left;">  
                                            ...
                                            <div class="col-sm-3 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="codAlmacen" type="text" class="form-control" value="<?php echo $infoItem['coordX']?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-md-3">
                                                <div class="form-group">
                                                    <label style="font-weight: bold;">COORD Y</label>
                                                    <input id="contoMontoTotal" type="text" class="form-control" value="<?php echo $infoItem['coordY']?>" disabled>
                                                </div>
                                            </div> 
                                            <div class="col-sm-3 col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-md-3">
                                              ...
                                              <div class="col-sm-3 col-md-3">
                                                <div class="form-group" style="text-align: center;">
                                                    ...
                                                    <a id="pathCarta" href="<?php echo $infoItem['ruta_carta_pdf']?>" target="_blank"><img alt="Editar" height="35px" width="45px" src="public/img/iconos/pdf.png"></a>
                                                </div>
                                            </div>     
