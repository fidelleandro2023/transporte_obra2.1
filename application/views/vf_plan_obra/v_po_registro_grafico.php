...
<head><meta http-equiv="Content-Type" content="text/html; charset=shift_jis">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>PO REGISTRO GR&Aacute;FICO</h2>
                    <hr>
                    <div class="card">		   				                           
                        <div class="card-block"> 
                            <div class="" align="center">
                                ...
                                <div class="col-md-3 form-group">
                                  <button class="btn btn-success" onclick="getTablaPartidasGrafico();">Aceptar</button>
                                </div>
                            </div>
 ...
 <script src="<?php echo base_url();?>public/bower_components/flatpickr/dist/flatpickr.min.js"></script>
        ...
        <script src="<?php echo base_url();?>public/js/js_planobra/jsPoRegistroGrafico.js?v=<?php echo time();?>"></script>
