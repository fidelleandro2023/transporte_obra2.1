...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>AN&Aacute;LISIS ECON&Oacute;MICO</h2>
                    <div class="card">		   				                    
                    
                        <div class="card-block"> 
							<div id="contTablaSisego" class="table-responsive">
                                <?php echo ($tablaAnalisisSisego) ? $tablaAnalisisSisego : null; ?>
                            </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Ingrese c&oacute;digo SIOM</label>
                            <input id="inputCodigoSiom" type="text" class="form-control input-mask" autocomplete="off" maxlength="7">
                            <i class="form-group__bar"></i>
                        </div>
                        <span id="valida"></span>
                    </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_planobra/jsAnalisisEconomico.js?v=<?php echo time();?>"></script>
