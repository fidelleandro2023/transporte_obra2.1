...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
				...
				<div class="content__inner">
					<h2>REGISTRO OBRA</h2>   
					<div class="col-sm-12 col-md-12" style="text-align: right; display:block;">
						<button class="btn btn-success waves-effect" type="button" onclick="sendToRegMasivoIp()" style="border-radius: 30px;">REGISTRO MASIVO</button>                     
					</div> 					
					<div class="card">		   				                        
								...
								<div class="row">
									...
									<div class="col-md-4">
									   ...
									   <div class="form-group col-sm-12" id="contPep1"  style="display:none">
										<div class="form-group">
											<label>nitem</label>
											<input id="nitem" name="nitem" type="text" class="form-control" readonly><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
										</div>
									   </div>

									   <div class="form-group col-sm-12" id="contCodUnico"  style="display:none">
										<div class="form-group">
											<label>validacion cod</label>
											<input id="inputCodUnico" name="inputCodUnico" type="text" class="form-control" ><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
										</div>
									   </div>
									...
									<div class="form-group col-sm-4 col-md-3" id="contCeco" style="display:none;">
										<label>CECO / PEP</label>
										<input id="inputCeco" name="inputCeco" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP"></i>
										<i class="form-group__bar"></i>
									</div>
									<div class="form-group col-sm-4 col-md-3" id="contCuenta" style="display:none;">
										<label>CUENTA</label>
										<input id="inputCuenta" name="inputCuenta" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP"></i>
										<i class="form-group__bar"></i>
									</div>
									<div class="form-group col-sm-4 col-md-3" id="contAreaFuncional" style="display:none;">
										<label>AREA FUNCIONAL</label>
										<input id="inputAreaFun" name="inputAreaFun" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP"></i>
										<i class="form-group__bar"></i>
									</div>
									...
									<div class="col-sm-4 col-md-4" id="contTipoEstudio" style="display:none">
										<div class="form-group">
											<label>TIPO ESTUDIO</label>
											<input id="inputTipoEstudio" name="inputTipoEstudio" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
										</div>
									</div>
									<div class="col-sm-4 col-md-4" id="contSegmento" style="display:none">
										<div class="form-group">
											<label>SEGMENTO</label>
											<input id="inputSegmento" name="inputSegmento" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
										</div>
									</div>
									<div class="col-sm-4 col-md-4" id="contServicio" style="display:none">
										<div class="form-group">
											<label>SERVICIO</label>
											<input id="inputServicio" name="inputServicio" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
										</div>
									</div>
									<div class="col-sm-4 col-md-4" id="contVelocidad" style="display:none">
										<div class="form-group">
											<label>VELOCIDAD</label>
											<input id="inputVelocidad" name="inputVelocidad" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
											<i class="form-group__bar"></i>
										</div>
									</div>
									...
									<div class="col-sm-4 col-md-4" id="nombre_plan" style="display:block">
										<div id="contInputCorreP" class="form-group has-feedback" style="">
									...
									<div class="col-sm-4 col-md-4" id="zona" style="display:block">
										<div id="contCmbZona" class="form-group has-feedback" style="">
											<label>ZONA</label>
											<select id="cmbZona" name="cmbZona" class="select2 form-control">
												<?php echo $cmbZona1_2; ?>
											</select>
									...
									<div class="col-sm-4 col-md-4" id="cont_requiere_h" style="display:block">
										<div id="contCheck" class="form-group has-feedback" style="">
											<label>REQUIERE HARDWARE?</label><br><br>
											<input type="checkbox" id="cbxRequiereH" name="cbxRequiereH" style="text-align: center;" disabled>
											<!-- <input id="inputNombrePlan" name="inputNombrePlan" type="text" class="form-control"><i class="form-control-feedback" data-bv-icon-for="inputCorreP"></i> -->
											<i class="form-group__bar"></i>
										</div>
									</div>								
   ...
   <!--  tables -->
        ...
        function changueCentral(){
			console.log("ENTRO IDCENTRAL: "+idCentralGlobal);
        ...
        // }
        	...
        	.bootstrapValidator({
        	    ...
        	    var $form    = $(e.target),
					...
					if(flgCapOpe == 1) {
						...
						if(flgOpex == 1 || flgOpex == 2){
							if(ceco == null || ceco == '' || ceco == undefined) {
							...
							if(aFuncional == null || aFuncional == '' || aFuncional == undefined) {
					...
					var inputTipoEstudio = $('#inputTipoEstudio').val();
					var inputSegmento = $('#inputSegmento').val();
					var inputServicio = $('#inputServicio').val();
					var inputVelocidad = $('#inputVelocidad').val();
					if(proyecto == 49) {			
					...
					var cbxRequiereH = $('#cbxRequiereH:checked').val();
					if(cbxRequiereH){
						cbxRequiereH = 1;
					...
					if(idContratoPadre == 1) {
						var zona = $('#cmbZona option:selected').val();
						
						if(zona ==  null || zona == '') {
							mostrarNotificacion('error','Verificar', 'Debe seleccionar la zona');
							return;
						}
					...
					if(idContrato ==  null || idContrato == '' || idContrato == 0) {
						mostrarNotificacion('error','Verificar', 'Debe seleccionar un contrato');
						return;
					}
						
					formData.append('cbxRequiereH', cbxRequiereH);
					formData.append('flgTipo', flgCapOpe);
					formData.append('pep1', pep1);
					formData.append('iter', iter);
					formData.append('tipoEstudio', inputTipoEstudio);
					formData.append('segmento', inputSegmento);
					formData.append('servicio', inputServicio);
					formData.append('velocidad', inputVelocidad);
					var nitemrango=$('#nitem').val()
			...
			function getCmbEmpresaColabByContratoPadre() {
				...
				if(idContratoPadre == null || idContratoPadre == '' || idContratoPadre == undefined){
					...
					console.log("idContratoPadre: "+idContratoPadre);
					if(idContratoPadre == 1) {
						$('#zona').css('display', 'block');
					} else {
						console.log("idContratoPadre none");
        ...
        ****************************************************/
		...
		function selectSubProyecto(flg) {
			...
			console.log("ENTRO1");
			capturar_dato_unico(idSubProyecto);
			cargarFaseSubproyecto(idSubProyecto)
			if(flg == 1){
				if(idSubProyecto == null || idSubProyecto == '' || idSubProyecto == undefined){console.log("ENTRO2");
					...
					$.ajax({
						...
						data = JSON.parse(data);
						if(data.error == 0) {console.log("ENTRO3");
							$('#selectContratoPadre').html(data.cmbContratoPadre);
							flgOpex = data.flg_reg_item_capex_opex;
							evaluarCapex(data.flg_reg_item_capex_opex, data.idTipoPlanta);
						} else {
							mostrarNotificacion('error', data.msj, 'Comunicarse con la persona a cargo');
						}
					});
		...
		function cargarFaseSubproyecto(subproyecto){
            ...
            .done(function(data){
                var data    =   JSON.parse(data);
                if(data.error == 0){       
					console.log("fases"+data.listaSubProy);
                    $('#selectFase').html(data.listaSubProy);
                    $('#selectFase').val('').trigger('chosen:updated');
		...
		function capturar_dato_unico(idsubproyecto){
      ...
      console.log("trio");
         ...
         $.ajax({
			...
			data = JSON.parse(data);
			console.log(data);
			 // alert(data[0].flg_codigounico);

			  if(data[0].flg_codigounico==2){

				$('#contCodigoUnico').css('display', 'inherit');
				    $('#contDepaMatriz').css('display', 'inherit');
				    $('#contProvMatriz').css('display', 'inherit');
				    $('#contDistrMatriz').css('display', 'inherit');
          

				$('#inputCodUnico').val(data[0].flg_codigounico);
		...
		function verificar_fase(){
           ...
           var identi;
			...
			console.log(fase_selec);
			
			$.ajax({
			type : 'POST',
			url  : 'ajaxCantidadxFase',
			data : { idsubproyecto :idSubProyecto, fase :fase_selec}
		}).done(function(data){
			data = JSON.parse(data);
			console.log("registrado"+data[0].registrado);
			console.log("items"+data[0].cantItemPlan);
			var registrado = 0;
			var cantPlanificado = 0;
					
			if(data[0].registrado	==	null){
				registrado = 0;					
			}else{
				registrado = parseInt(data[0].registrado);
			}
			
			if(data[0].cantItemPlan	==	null){
				cantPlanificado = 0;					
			}else{
				cantPlanificado = parseInt(data[0].cantItemPlan);
			}
			
			// if(registrado<cantPlanificado){
				// $('#nitem').val('1')

			// }else{
				// $('#nitem').val('2')
				// mostrarNotificacion('error', 'la cuota de itemplan en fase fue excedida', 'verificar');
							// return;
		...
		function evaluarCapex(flg, idTipoPlanta){
			console.log("idTipoPlanta : "+idTipoPlanta);
			if(idTipoPlanta == 4) {
				$('#contTipoEstudio').css('display', 'block');
				$('#contSegmento').css('display', 'block');
				$('#contServicio').css('display', 'block');
				$('#contVelocidad').css('display', 'block');
			} else {
				$('#inputVelocidad').val('');
				$('#inputServicio').val('');
				$('#inputSegmento').val('');
				$('#inputTipoEstudio').val('');

				$('#contTipoEstudio').css('display', 'none');
				$('#contSegmento').css('display', 'none');
				$('#contServicio').css('display', 'none');
				$('#contVelocidad').css('display', 'none');
			}

			if(flg == 1 || flg == 2){
				//alert("existe capex"+n);

				//$('#nombre_plan').css('display', 'block');
				$('#contInputIndicador').css('display', 'block');
				console.log("flg : "+flg);
				if(flg == 2){
					$('#contPep2').css('display', 'none');
		...
		function sendToRegMasivoIp(){        	
        	window.location.href = 'regMasivoIpTransporte';
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCJGM8X6T-cmhda5ttB2HBR-TLepw_19T4&libraries=places&callback=init"></script>
