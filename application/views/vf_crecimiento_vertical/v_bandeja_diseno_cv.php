...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <main class="main">
            ...
            <section class="content content--full">
                <div class="content__inner">
                    <h2>DISE&Ntilde;O CRECIMIENTO VERTICAL</h2>
                    <div class="card">		   				                    
                        ...
                        <div class="card-block">
                            ...
                            <div id="contTabla" class="table-responsive">
                                <?php echo $tablaAnalisisEconomico ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formFiles" method="post" class="form-horizontal" enctype="multipart/form-data"> 
                            <div class="form-group">
                                <label>TSS</label>
                                <input id="tss" name="tss" type="file" required accept=".pdf" class="form-control input-mask">
                                <i class="form-group__bar"></i>
                                <div id="mensajeTss"></div>
                            </div>
                            <div class="form-group">
                                <label>EXPEDIENTE</label>
                                <input id="expediente" name="expediente" type="file" required accept=".pdf" class="form-control input-mask">
                                <i class="form-group__bar"></i>
                                <div id="mensajeExped"></div>
                            </div>
                            <div class="form-group">
                                <label>Comentario</label>
                                <textarea id="comentario" name="comentario" class="form-control input-mask"></textarea>
                                <i class="form-group__bar"></i>
                            </div>
   ...
   <!--  tables -->
        ...
        <script src="<?php echo base_url();?>public/js/js_crecimiento_vertical/jsBandejaDisenoCv.js?v=<?php echo time();?>"></script>
