...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
 ...
 <?php include('application/views/v_opciones.php'); ?>
                  				...
                  				<div class="col-md-12">
                  				 <div class="tab-container tab-container--green">
                                        <ul class="nav nav-tabs nav-fill" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#messages-4" role="tab">DATOS DE LA CONSTRUCTORA</a>
                                            </li>    
                                             <li class="nav-item">
                            		...
                            		<div class="row">
                                        ...
                                        <div style="display: none;text-align: center;" id="contUploadFileCoti" class="col-sm-3 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="fileupload" name="fileupload" type="file" onchange='cambiar()' multiple accept='image/*' style='display: none;'>
                                ...
                                <div class="tab-pane fade" id="messages-4" role="tabpanel">
                                	<div class="row">
                                            ...
                                            <div class="form-group col-sm-12">                                             	
                                              	<label style="font-weight: bold;color: black;">OBSERVACIONES</label>
        ...
        <script>
  	    ...
  	    <script src="<?php echo base_url();?>public/js/js_crecimiento_vertical/edit_crecimiento_vertical.js?v=<?php echo time();?>"></script>
		...
		$('#seletContrata').val(<?php echo "'".$idCentral."'"?>).trigger('change');
