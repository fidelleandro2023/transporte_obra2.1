...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
 ...
 <?php include('application/views/v_opciones.php'); ?>
                  				...
                  				<div class="col-md-12">
                  				 <div class="tab-container tab-container--green">
                                        <ul class="nav nav-tabs nav-fill" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#home-4" role="tab">UBICACION</a>
                                            </li>
                                            <li class="nav-item">
                               			...
                               			<div class="row">
                                            ...
                                            <div class="form-group form-group--float col-sm-12">
                                           	...
                                           	<div class="form-group form-group--float col-sm-6">
                                                <input value="<?php echo $coordenada_x?>" disabled style="font-weight: bold;color: black;" id="txt_coord_x" name="txt_coord_x" type="text" onchange="changeXY()" class="form-control form-control-sm form-control--active">
                                                <label style="font-weight: bold;color: black;">COORDENADA X</label>
                                                <i class="form-group__bar"></i>
                                            </div>
                                            <div class="form-group form-group--float col-sm-6">
                                                <input value="<?php echo $coordenada_y?>" disabled style="font-weight: bold;color: black;" id="txt_coord_y" name="txt_coord_y" type="text" onchange="changeXY()" class="form-control form-control-sm form-control--active">
                		  ...
                		  <div class="tab-pane fade" id="profile-4" role="tabpanel">
                            		<div class="row"> 
                                        ...
                                        <div class="form-group col-sm-2">
                                            ...
                                            <select id="cmbTipoSubProyecto" name="cmbTipoSubProyecto" class="select2" onchange="getSubProyectoByTipo();">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <select id="cmbSubProyecto" name="cmbSubProyecto" class="select2" onchange="getEmpresaColabByMdf();">
                                                <option value="">.:Seleccionar:.</option>
                                            </select>
                                        </div> 
                                        <div class="form-group col-sm-3">
                                        ...
                                        <div class="form-group col-sm-3">
                                         ...
                                         <div class="form-group col-sm-3">
                                           <label style="font-weight: bold;color: var(--azul_telefonica);">% AVANCE</label>
                                            <select id="txt_avance" name="txt_avance" class="select2" disabled>                                                     	
                                        ...
                                        <div style="display: none;text-align: center;" id="contUploadFileCoti" class="col-sm-3 col-md-3">
                                            ...
                                            <div class="form-group col-sm-3">
                                             ...
                                             <div class="form-group col-sm-3">
                                               <label style="font-weight: bold;color: var(--azul_telefonica);">FASE</label>
                                                <select id="selectFase" name="selectFase" class="select2" disabled>
                                                     <?= $cmbFase ?>
                                                </select>                                             
                                            </div>
                                            <div class="form-group form-group--float col-sm-3">
                                                <input maxlength="250" style="border-bottom-color: #838e83;" value="" id="txtOperador" name="txtOperador" type="text" class="form-control form-control-sm form-control--active">
                                	...
                                	<div class="row">
                                			<div class="form-group form-group--float col-sm-4">
                                             ...
                                             <div class="form-group form-group--float col-sm-3">
                                                ...
                                                <label style="font-weight: bold;color: var(--azul_telefonica);">TELEFONO 1/2</label>
                                                <i class="form-group__bar"></i>
                                            </div>
                                             <div class="form-group form-group--float col-sm-3">
        ...
        <script>
  	    ...
  	    <script src="<?php echo base_url();?>public/js/js_crecimiento_vertical/jsBandejaRegCvNegocio.js?v=<?php echo time();?>"></script>
		...
		// $('#selectEECC').val(<?php echo "'".$idEmpresaColab."'"?>).trigger('change');
