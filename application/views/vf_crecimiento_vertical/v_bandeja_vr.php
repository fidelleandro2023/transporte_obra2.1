...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body data-ma-theme="entel">
        <main class="main">
            ...
            <!--Empezar a modificar codigo para VR -->
            <section class="content content--full">
           
		                   <div class="content__inner">
                                    <h2>BANDEJA ESTATUS VALE DE RESERVA</h2>
		   				                    <div class="card">
   ...
   <!--  tables -->
        ...
        <script type="text/javascript">
            ...
            function getDetalleItemPlans(component){
                ...
                var idEECC = $(component).data('ideecc');
                var descEECC = $(component).data('desceecc');
                    ...
                    .done(function(data){             	    
                        ...
                        if(data.error == 0){
                            $('#tituloModal').html(data.descEmpresaColab);
                            $('#contTablaDetItemPlan').html(data.tablaDetalleItemPlan);	    						
                            initDataTable('#tabla_detalle');
                            modal('modal_detalle');     				
                        }else if(data.error == 1){   				    	
                            mostrarNotificacion('error','Error','Hubo un error al traer el detalle');
                        }
                    })  	              
            }

            function filtrarTabla(){
                var idEmpresaColab = $.trim($("#selectEECC").val());
                var fechaInicio = $.trim($('#fechaInicio').val()); 
        	    var fechaFin 	= $.trim($('#fechaFin').val()); 

                if(idEmpresaColab == 0){
                    mostrarNotificacion('warning','Aviso', 'Debe seleccionar una ECC para realizar la b&uacute;squeda!!');
                    return;
                }

                $.ajax({
                    type	:	'POST',
                    'url'	:	'getReportVRByFilt',
