        ...
        <div class="modal fade"id="modalEditEjec"  tabindex="-1">
            ...
            <div class="modal fade" id="modalEditEntidadesEjec"  tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" style="margin: auto;font-weight: bold;"><?php echo ($flg_principal == 0) ? '(SISEGO PRINCIPAL)' : '(SISEGO RESPALDO)';  ?></h3>    
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <div class="">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-3 col-md-4">
                                                                    <div class="form-group has-feedback" style="">
                                                                        ...
                                                                        <input onchange="getcalculos()" id="inputCostoMat" name="inputCostoMat" type="number" class="form-control" value="<?php echo isset($costo_materiales) ? $costo_materiales : NULL; ?>"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
                                                                        <i class="form-group__bar"></i>
                                                                ...
                                                                <div class="col-sm-3 col-md-4">
                                                                    <div class="form-group has-feedback" style="">
                                                                        ...
                                                                        <input onchange="getcalculos()" id="inputCostMo" name="inputCostMo" type="number" class="form-control" value="<?php echo isset($costo_mano_obra) ? $costo_mano_obra : NULL; ?>"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
                                                                        <i class="form-group__bar"></i>
                                                                ...
                                                                <div class="col-sm-3 col-md-4">
                                                                    <div class="form-group has-feedback" style="">
                                                                        ...
                                                                        <input onchange="getcalculos()" id="inputCostoDiseno" name="inputCostoDiseno" type="number" class="form-control" value="<?php echo isset($costo_diseno) ? $costo_diseno : NULL; ?>"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
                                                                        <i class="form-group__bar"></i>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 col-md-4">
                                                                    <div class="form-group has-feedback" style="">
                                                                        ...
                                                                        <input onchange="getcalculos()" id="inputCostoAdicZona" name="inputCostoAdicZona" type="number" class="form-control" value="<?php echo isset($costo_adicional_rural) ? $costo_adicional_rural : NULL; ?>"><i class="form-control-feedback" data-bv-icon-for="inputCorreP" ></i>
                                                                        <i class="form-group__bar"></i>
