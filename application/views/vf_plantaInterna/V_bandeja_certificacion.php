                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input id="fechaIn" type="date" class="form-control" onchange="filtrarTabla('filtrarCertificacion');">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Fecha Fin.</label>
                                    <input id="fechaFin" type="date" class="form-control" onchange="filtrarTabla('filtrarCertificacion');">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>EECC.</label>
                                    <select id="cmbEec" class="select2 form-control" onchange="filtrarTabla('filtrarCertificacion');">
                        ...
                        <div class="form-group">
                            <input type="text" style="width:30px;background:#FDBDBD" disabled>
                            <label>TIENE PEP</label>
