...
<html lang="en">
            ...
            <div id="modalEditarPTR" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">PO ACTUALIZADO</h4>
                        </div>
                        <div class="modal-body">
                            <!-- <div class="form-group">
                        ...
                        -->
                            <div class="panel panel-primary">
                                <div class="panel-heading">Partidas Asociadas</div>
                                    <div class="panel-body">
    ...
    <script src="<?php echo base_url();?>public/js/js_planta_interna/jsBandejaValidacion.js?v=<?php echo time();?>"></script>
